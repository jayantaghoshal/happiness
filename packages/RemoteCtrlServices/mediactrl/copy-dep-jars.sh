...
# Gateway
GATEWAY_SHARED_LIBS_PATH="${REPO_ROOT_DIR}/vendor/volvocars/packages/RemoteCtrlServices/mediactrl/gateway/app/libs/"
...
# Service
SERVICE_SHARED_LIBS_PATH="${REPO_ROOT_DIR}/vendor/volvocars/packages/RemoteCtrlServices/mediactrl/service/app/libs/"
