...
public class HalHandler {
  ...
  public void updateVolume(byte audioContext, byte volumeLevel) {
    ...
    try {
      ...
      Log.e(TAG, "Error calling updateVolume function on native HAL interface: " + ex.getMessage());
    }
  }
  ...
  public void sendGetVolumeResp(int requestIdentifier, boolean requestStatus, byte audioContext, byte volumeLevel) {
    ...
    try {
      ...
      Log.e(TAG, "Error calling sendGetVolumeResp function on native HAL interface: " + ex.getMessage());
    }
  }
  ...
  public void sendSetVolumeResp(int requestIdentifier, boolean requestStatus) {
    try {
      ...
      Log.e(TAG, "Error calling sendSetVolumeResp function over native HAL interface: " + ex.getMessage());
    }
  }
    ...
    public void getVolume(short requestIdentifier, byte context) {
      ...
      synchronized(this){
        try {
          ...
          Log.e(TAG, "Error forwarding GetVolume request to appService : " + ex.getMessage());
        }
      }
    }
    ...
    public void setVolume(short requestIdentifier, VolumeData data) {
      ...
      synchronized(this) {
        try {
          ...
          Log.e(TAG, "Error forwarding SetVolume request to appService : " + ex.getMessage());
        }
      }
    }
