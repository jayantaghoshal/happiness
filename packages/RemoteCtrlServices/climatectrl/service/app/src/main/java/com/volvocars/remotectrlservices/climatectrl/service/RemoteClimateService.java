                ...
                public void onChangeEvent(CarPropertyValue value) {
                    try {
                        ...
                        if (mPropertiesListeningOn.contains(value.getPropertyId())) {
                            RemoteCtrlPropertyValue response = CarPropertyUtils.toRemoteCtrlPropertyValue(value);
                            Log.v(TAG, "RemoteCtrlPropertyValue: " + response);
                            mIRemoteClimateResponseService.notifyPropertyChanged(response);
                        } else {
