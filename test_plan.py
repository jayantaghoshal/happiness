...
test_plan_hourly = test_plan_gate + [
    ...
    VTSTest("vendor/volvocars/hardware/pac/evs/hardware/lib/lvdslink/test/ut/",     standard_caps), #VtsHalPacEvsHardwareLvdslink, Lars Brange
...
test_plan_staging_hourly = [
    ...
    TradefedTest("vendor/volvocars/packages/SoftwareUpdateService/test/ct/test_suites/HappyAssignInstallation",      standard_caps), #Matilda Bengtsson
    ...
    VTSTest("vendor/volvocars/hardware/netman/test/ct/ethernet_connectivity",       standard_caps | {cp.audio}), #Anitha K Swamy
]
