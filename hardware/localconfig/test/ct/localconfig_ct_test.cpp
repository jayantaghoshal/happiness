...
TEST_F(LocalConfigOnTargetTest, LocalConfigTestGetInt) {
    EXPECT_NO_THROW(lcfg_->GetInt("IIPS_LM_NofNodesRG1"));
}
...
TEST_F(LocalConfigOnTargetTest, LocalConfigTestGetBoolean) {
    EXPECT_TRUE(lcfg_->GetBool("TEST_KEY_BOOLEAN"));
}
