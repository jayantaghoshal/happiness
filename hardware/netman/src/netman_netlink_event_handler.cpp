...
NetmanNetlinkEventHandler::NetmanNetlinkEventHandler(const std::vector<InterfaceConfiguration> &interface_configurations)
    : interface_configurations_(interface_configurations)
{
}

void NetmanNetlinkEventHandler::HandleNewLinkEvent(struct nlmsghdr *nl_message_header,
