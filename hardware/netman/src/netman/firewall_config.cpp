...
bool FirewallConfig::ParseAndSave(const std::string& output_path) {
    ...
    ParseRules(mangle_, "MANGLE_TABLE", output_file);
...
void FirewallConfig::InitTables() {
    ...
    nat_table_.name = "*nat";
    nat_table_.chains = {
            ":PREROUTING ACCEPT [0:0]", ":INPUT ACCEPT [0:0]", ":OUTPUT ACCEPT [0:0]", ":POSTROUTING ACCEPT [0:0]"};
    nat_table_.rules = {};
    ...
    mangle_.top_comment = "# Generated by LCFG on ...";
    mangle_.name = "*mangle";
    mangle_.chains = {
            ":PREROUTING ACCEPT [0:0]", ":INPUT ACCEPT [0:0]", ":OUTPUT ACCEPT [0:0]", ":POSTROUTING ACCEPT [0:0]"};
    mangle_.rules = {};
    mangle_.final = "COMMIT\n# Completed on ...";
}
