...
class VtsNetmandIpConfigurationComponentTest(base_test.BaseTestClass):
    ...
    def testEth1_Runtime_IpAddress(self):
        ...
        # Act
        self.target.set_ip_address(self.ETH1, invalid_ip_address)
    ...
    def testEth1_RunTime_BroadcastAddress(self):
        ...
        # Act
        self.target.set_broadcast_address(self.ETH1, invalid_broadcast_address)
    ...
    def testEth1_Runtime_Netmask(self):
        ...
        # Act
        self.target.set_netmask(self.ETH1, "255.255.255.0")
    ...
    def testEth1_Runtime_Mtu(self):
        ...
        # Act
        self.target.set_mtu(self.ETH1, 1000)
    ...
    def testEth1_Runtime_MacAddress(self):
        ...
        # Act
        self.target.interface_down(self.ETH1)
        self.target.set_mac_address(self.ETH1, "02:00:00:02:12:05")
        self.target.interface_up(self.ETH1)
