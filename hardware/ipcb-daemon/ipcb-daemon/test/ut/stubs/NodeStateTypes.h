...
#define NSM_LIFECYCLE_OBJECT \
    "/org/genivi/NodeStateManager/LifecycleControl"                 /**< Address of the lifecycle object        */
...
#define NSM_SHUTDOWNTYPE_RUNUP                                       \
    0x80000000U /**< The shutdown type "run up" can not be used for  \
