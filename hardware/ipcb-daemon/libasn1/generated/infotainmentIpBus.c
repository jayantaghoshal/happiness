...
// ASN File: C:\temp\icup\ihu_infotainment-ip-service\libasn1\spec\infotainmentIpBus.asn time:12:19:18 tisdag 2016 november 1
//
...
{
  Icb_OpSVTStatus_Response value = ( Icb_OpSVTStatus_Response ) ASN_Malloc( session, sizeof( struct Icb_OpSVTStatus_Response_t ) );
...
{
  Icb_OpSVTStatus_Notification value = ( Icb_OpSVTStatus_Notification ) ASN_Malloc( session, sizeof( struct Icb_OpSVTStatus_Notification_t ) );
...
ASN_Result Icb_OpSVTStatus_Notification_Decode( Icb_OpSVTStatus_Notification ThisPtr, ASN_Session session, ASN_Stream stream )
{
  BOOL hasExtensions;
  ASN_Result result = ASN_RESULT_OK;
...
{
  Icb_OpTNStatus_Response value = ( Icb_OpTNStatus_Response ) ASN_Malloc( session, sizeof( struct Icb_OpTNStatus_Response_t ) );
...
{
  Icb_OpTNStatus_Notification value = ( Icb_OpTNStatus_Notification ) ASN_Malloc( session, sizeof( struct Icb_OpTNStatus_Notification_t ) );
...
ASN_Result Icb_OpTNStatus_Notification_Decode( Icb_OpTNStatus_Notification ThisPtr, ASN_Session session, ASN_Stream stream )
{
  BOOL hasExtensions;
  ASN_Result result = ASN_RESULT_OK;
...
{
  Icb_SimpleVehiclePosition value = ( Icb_SimpleVehiclePosition ) ASN_Malloc( session, sizeof( struct Icb_SimpleVehiclePosition_t ) );
...
{
  Icb_OpServiceActivation_Response value = ( Icb_OpServiceActivation_Response ) ASN_Malloc( session, sizeof( struct Icb_OpServiceActivation_Response_t ) );
...
ASN_Result Icb_OpServiceActivation_Response_Decode( Icb_OpServiceActivation_Response ThisPtr, ASN_Session session, ASN_Stream stream )
{
  BOOL hasExtensions;
  ASN_Result result = ASN_RESULT_OK;
...
{
  Icb_OpTextMessage_SetRequest value = ( Icb_OpTextMessage_SetRequest ) ASN_Malloc( session, sizeof( struct Icb_OpTextMessage_SetRequest_t ) );
...
ASN_Result Icb_OpTextMessage_SetRequest_Decode( Icb_OpTextMessage_SetRequest ThisPtr, ASN_Session session, ASN_Stream stream )
{
  BOOL hasExtensions;
  ASN_Result result = ASN_RESULT_OK;
...
{
  Icb_OpIHUSystemInfo_Response value = ( Icb_OpIHUSystemInfo_Response ) ASN_Malloc( session, sizeof( struct Icb_OpIHUSystemInfo_Response_t ) );
...
ASN_Result Icb_OpIHUSystemInfo_Response_Decode( Icb_OpIHUSystemInfo_Response ThisPtr, ASN_Session session, ASN_Stream stream )
{
  BOOL hasExtensions;
  ASN_Result result = ASN_RESULT_OK;
...
{
  Icb_UserPrivacySettings value = ( Icb_UserPrivacySettings ) ASN_Malloc( session, sizeof( struct Icb_UserPrivacySettings_t ) );
...
{
  Icb_OpSoHWarning_Notification value = ( Icb_OpSoHWarning_Notification ) ASN_Malloc( session, sizeof( struct Icb_OpSoHWarning_Notification_t ) );
...
ASN_Result Icb_OpSoHWarning_Notification_Decode( Icb_OpSoHWarning_Notification ThisPtr, ASN_Session session, ASN_Stream stream )
{
  ASN_Result result = ASN_RESULT_OK;
...
{
  Icb_OpServiceBooking_Notification value = ( Icb_OpServiceBooking_Notification ) ASN_Malloc( session, sizeof( struct Icb_OpServiceBooking_Notification_t ) );
...
ASN_Result Icb_OpServiceBooking_Notification_Decode( Icb_OpServiceBooking_Notification ThisPtr, ASN_Session session, ASN_Stream stream )
{
  ASN_Result result = ASN_RESULT_OK;
...
{
  Icb_OpSoHPackageUploaded_Notification value = ( Icb_OpSoHPackageUploaded_Notification ) ASN_Malloc( session, sizeof( struct Icb_OpSoHPackageUploaded_Notification_t ) );
...
ASN_Result Icb_OpSoHPackageUploaded_Notification_Decode( Icb_OpSoHPackageUploaded_Notification ThisPtr, ASN_Session session, ASN_Stream stream )
{
  ASN_Result result = ASN_RESULT_OK;
...
ASN_Result Icb_OpSoHPackageUploaded_Notification_Encode( Icb_OpSoHPackageUploaded_Notification ThisPtr, ASN_Stream stream)
{
  ASN_Result result = ASN_RESULT_OK;
...
{
  Icb_OpPSIMResetDataCounter_SetRequest value = ( Icb_OpPSIMResetDataCounter_SetRequest ) ASN_Malloc( session, sizeof( struct Icb_OpPSIMResetDataCounter_SetRequest_t ) );
...
ASN_Result Icb_OpPSIMResetDataCounter_SetRequest_Decode( Icb_OpPSIMResetDataCounter_SetRequest ThisPtr, ASN_Session session, ASN_Stream stream )
{
  BOOL hasExtensions;
  ASN_Result result = ASN_RESULT_OK;
...
ASN_Result Icb_OpPSIMResetDataCounter_SetRequest_Encode( Icb_OpPSIMResetDataCounter_SetRequest ThisPtr, ASN_Stream stream)
{
  ASN_Result result = ASN_RESULT_OK;
...
{
  Icb_OpPSIMResetDataCounter_Response value = ( Icb_OpPSIMResetDataCounter_Response ) ASN_Malloc( session, sizeof( struct Icb_OpPSIMResetDataCounter_Response_t ) );
...
ASN_Result Icb_OpPSIMResetDataCounter_Response_Decode( Icb_OpPSIMResetDataCounter_Response ThisPtr, ASN_Session session, ASN_Stream stream )
{
  BOOL hasExtensions;
  ASN_Result result = ASN_RESULT_OK;
...
{
  Icb_AutomaticAPNConfiguration value = ( Icb_AutomaticAPNConfiguration ) ASN_Malloc( session, sizeof( struct Icb_AutomaticAPNConfiguration_t ) );
...
ASN_Result Icb_AutomaticAPNConfiguration_Decode( Icb_AutomaticAPNConfiguration ThisPtr, ASN_Session session, ASN_Stream stream )
{
  ASN_Result result = ASN_RESULT_OK;
...
{
  Icb_OpPSIMConnect_SetRequest value = ( Icb_OpPSIMConnect_SetRequest ) ASN_Malloc( session, sizeof( struct Icb_OpPSIMConnect_SetRequest_t ) );
...
ASN_Result Icb_OpPSIMConnect_SetRequest_Decode( Icb_OpPSIMConnect_SetRequest ThisPtr, ASN_Session session, ASN_Stream stream )
{
  ASN_Result result = ASN_RESULT_OK;
...
{
  Icb_OpPSIMConnect_Response value = ( Icb_OpPSIMConnect_Response ) ASN_Malloc( session, sizeof( struct Icb_OpPSIMConnect_Response_t ) );
...
ASN_Result Icb_OpPSIMConnect_Response_Decode( Icb_OpPSIMConnect_Response ThisPtr, ASN_Session session, ASN_Stream stream )
{
  ASN_Result result = ASN_RESULT_OK;
  ASN_DECODE_CHECK( Icb_OnOffSetting_Decode( &ThisPtr->onOff, session, stream ) );
  return ASN_RESULT_OK;
...
{
  Icb_OpPSIMRoamingConfiguration_SetRequest value = ( Icb_OpPSIMRoamingConfiguration_SetRequest ) ASN_Malloc( session, sizeof( struct Icb_OpPSIMRoamingConfiguration_SetRequest_t ) );
...
ASN_Result Icb_OpPSIMRoamingConfiguration_SetRequest_Decode( Icb_OpPSIMRoamingConfiguration_SetRequest ThisPtr, ASN_Session session, ASN_Stream stream )
{
  BOOL hasExtensions;
  ASN_Result result = ASN_RESULT_OK;
...
ASN_Result Icb_OpPSIMRoamingConfiguration_SetRequest_Encode( Icb_OpPSIMRoamingConfiguration_SetRequest ThisPtr, ASN_Stream stream)
{
  ASN_Result result = ASN_RESULT_OK;
...
{
  Icb_OpPSIMRoamingConfiguration_Response value = ( Icb_OpPSIMRoamingConfiguration_Response ) ASN_Malloc( session, sizeof( struct Icb_OpPSIMRoamingConfiguration_Response_t ) );
...
ASN_Result Icb_OpPSIMRoamingConfiguration_Response_Decode( Icb_OpPSIMRoamingConfiguration_Response ThisPtr, ASN_Session session, ASN_Stream stream )
{
  BOOL hasExtensions;
  ASN_Result result = ASN_RESULT_OK;
...
ASN_Result Icb_OpPSIMRoamingConfiguration_Response_Encode( Icb_OpPSIMRoamingConfiguration_Response ThisPtr, ASN_Stream stream)
{
  ASN_Result result = ASN_RESULT_OK;
...
{
  Icb_OpAccessRightPinCode_Response value = ( Icb_OpAccessRightPinCode_Response ) ASN_Malloc( session, sizeof( struct Icb_OpAccessRightPinCode_Response_t ) );
...
ASN_Result Icb_OpAccessRightPinCode_Response_Decode( Icb_OpAccessRightPinCode_Response ThisPtr, ASN_Session session, ASN_Stream stream )
{
  BOOL hasExtensions;
  ASN_Result result = ASN_RESULT_OK;
...
{
  Icb_OpFactoryDefaultRestore_Response value = ( Icb_OpFactoryDefaultRestore_Response ) ASN_Malloc( session, sizeof( struct Icb_OpFactoryDefaultRestore_Response_t ) );
...
ASN_Result Icb_OpFactoryDefaultRestore_Response_Decode( Icb_OpFactoryDefaultRestore_Response ThisPtr, ASN_Session session, ASN_Stream stream )
{
  ASN_Result result = ASN_RESULT_OK;
...
{
  Icb_OpConnectivityStatus_Response value = ( Icb_OpConnectivityStatus_Response ) ASN_Malloc( session, sizeof( struct Icb_OpConnectivityStatus_Response_t ) );
...
ASN_Result Icb_OpConnectivityStatus_Response_Decode( Icb_OpConnectivityStatus_Response ThisPtr, ASN_Session session, ASN_Stream stream )
{
  ASN_Result result = ASN_RESULT_OK;
...
{
  Icb_OpConnectivityStatus_Notification value = ( Icb_OpConnectivityStatus_Notification ) ASN_Malloc( session, sizeof( struct Icb_OpConnectivityStatus_Notification_t ) );
...
ASN_Result Icb_OpConnectivityStatus_Notification_Decode( Icb_OpConnectivityStatus_Notification ThisPtr, ASN_Session session, ASN_Stream stream )
{
  ASN_Result result = ASN_RESULT_OK;
  ASN_DECODE_CHECK( BOOL_Decode( &ThisPtr->generalConnectivityAvailable, session, stream ) );
  return ASN_RESULT_OK;
...
ASN_Result Icb_OpConnectivityStatus_Notification_Encode( Icb_OpConnectivityStatus_Notification ThisPtr, ASN_Stream stream)
{
  ASN_Result result = ASN_RESULT_OK;
  ASN_ENCODE_CHECK( BOOL_Encode( ThisPtr->generalConnectivityAvailable, stream) );
  return ASN_RESULT_OK;
...
{
  Icb_OpWorkshopWlanDetected_Notification value = ( Icb_OpWorkshopWlanDetected_Notification ) ASN_Malloc( session, sizeof( struct Icb_OpWorkshopWlanDetected_Notification_t ) );
...
ASN_Result Icb_OpWorkshopWlanDetected_Notification_Decode( Icb_OpWorkshopWlanDetected_Notification ThisPtr, ASN_Session session, ASN_Stream stream )
{
  ASN_Result result = ASN_RESULT_OK;
...
ASN_Result Icb_OpWorkshopWlanDetected_Notification_Encode( Icb_OpWorkshopWlanDetected_Notification ThisPtr, ASN_Stream stream)
{
  ASN_Result result = ASN_RESULT_OK;
...
{
  Icb_OpInternetSourceCtrlBT_SetRequest value = ( Icb_OpInternetSourceCtrlBT_SetRequest ) ASN_Malloc( session, sizeof( struct Icb_OpInternetSourceCtrlBT_SetRequest_t ) );
...
ASN_Result Icb_OpInternetSourceCtrlBT_SetRequest_Decode( Icb_OpInternetSourceCtrlBT_SetRequest ThisPtr, ASN_Session session, ASN_Stream stream )
{
  ASN_Result result = ASN_RESULT_OK;
  ASN_DECODE_CHECK( Icb_OnOffSetting_Decode( &ThisPtr->onOff, session, stream ) );
  return ASN_RESULT_OK;
...
ASN_Result Icb_OpInternetSourceCtrlBT_SetRequest_Encode( Icb_OpInternetSourceCtrlBT_SetRequest ThisPtr, ASN_Stream stream)
{
  ASN_Result result = ASN_RESULT_OK;
  ASN_ENCODE_CHECK( Icb_OnOffSetting_Encode( ThisPtr->onOff, stream) );
  return ASN_RESULT_OK;
...
{
  Icb_OpInternetSourceCtrlBT_Response value = ( Icb_OpInternetSourceCtrlBT_Response ) ASN_Malloc( session, sizeof( struct Icb_OpInternetSourceCtrlBT_Response_t ) );
...
ASN_Result Icb_OpInternetSourceCtrlBT_Response_Decode( Icb_OpInternetSourceCtrlBT_Response ThisPtr, ASN_Session session, ASN_Stream stream )
{
  ASN_Result result = ASN_RESULT_OK;
  ASN_DECODE_CHECK( Icb_OnOffSetting_Decode( &ThisPtr->onOff, session, stream ) );
  return ASN_RESULT_OK;
...
{
  Icb_OpInternetSourceCtrlBT_Notification value = ( Icb_OpInternetSourceCtrlBT_Notification ) ASN_Malloc( session, sizeof( struct Icb_OpInternetSourceCtrlBT_Notification_t ) );
...
ASN_Result Icb_OpInternetSourceCtrlBT_Notification_Decode( Icb_OpInternetSourceCtrlBT_Notification ThisPtr, ASN_Session session, ASN_Stream stream )
{
  ASN_Result result = ASN_RESULT_OK;
  ASN_DECODE_CHECK( Icb_OnOffSetting_Decode( &ThisPtr->onOff, session, stream ) );
  return ASN_RESULT_OK;
...
ASN_Result Icb_OpInternetSourceCtrlBT_Notification_Encode( Icb_OpInternetSourceCtrlBT_Notification ThisPtr, ASN_Stream stream)
{
  ASN_Result result = ASN_RESULT_OK;
  ASN_ENCODE_CHECK( Icb_OnOffSetting_Encode( ThisPtr->onOff, stream) );
  return ASN_RESULT_OK;
...
{
  Icb_OpInternetSourceCtrlUSB_SetRequest value = ( Icb_OpInternetSourceCtrlUSB_SetRequest ) ASN_Malloc( session, sizeof( struct Icb_OpInternetSourceCtrlUSB_SetRequest_t ) );
...
ASN_Result Icb_OpInternetSourceCtrlUSB_SetRequest_Decode( Icb_OpInternetSourceCtrlUSB_SetRequest ThisPtr, ASN_Session session, ASN_Stream stream )
{
  ASN_Result result = ASN_RESULT_OK;
  ASN_DECODE_CHECK( Icb_OnOffSetting_Decode( &ThisPtr->onOff, session, stream ) );
  return ASN_RESULT_OK;
...
ASN_Result Icb_OpInternetSourceCtrlUSB_SetRequest_Encode( Icb_OpInternetSourceCtrlUSB_SetRequest ThisPtr, ASN_Stream stream)
{
  ASN_Result result = ASN_RESULT_OK;
  ASN_ENCODE_CHECK( Icb_OnOffSetting_Encode( ThisPtr->onOff, stream) );
  return ASN_RESULT_OK;
...
{
  Icb_OpInternetSourceCtrlUSB_Response value = ( Icb_OpInternetSourceCtrlUSB_Response ) ASN_Malloc( session, sizeof( struct Icb_OpInternetSourceCtrlUSB_Response_t ) );
...
ASN_Result Icb_OpInternetSourceCtrlUSB_Response_Decode( Icb_OpInternetSourceCtrlUSB_Response ThisPtr, ASN_Session session, ASN_Stream stream )
{
  ASN_Result result = ASN_RESULT_OK;
  ASN_DECODE_CHECK( Icb_OnOffSetting_Decode( &ThisPtr->onOff, session, stream ) );
  return ASN_RESULT_OK;
...
{
  Icb_OpInternetSourceCtrlUSB_Notification value = ( Icb_OpInternetSourceCtrlUSB_Notification ) ASN_Malloc( session, sizeof( struct Icb_OpInternetSourceCtrlUSB_Notification_t ) );
...
ASN_Result Icb_OpInternetSourceCtrlUSB_Notification_Decode( Icb_OpInternetSourceCtrlUSB_Notification ThisPtr, ASN_Session session, ASN_Stream stream )
{
  ASN_Result result = ASN_RESULT_OK;
  ASN_DECODE_CHECK( Icb_OnOffSetting_Decode( &ThisPtr->onOff, session, stream ) );
  return ASN_RESULT_OK;
...
ASN_Result Icb_OpInternetSourceCtrlUSB_Notification_Encode( Icb_OpInternetSourceCtrlUSB_Notification ThisPtr, ASN_Stream stream)
{
  ASN_Result result = ASN_RESULT_OK;
  ASN_ENCODE_CHECK( Icb_OnOffSetting_Encode( ThisPtr->onOff, stream) );
  return ASN_RESULT_OK;
...
{
  Icb_OpPSIMMessage_SetRequest value = ( Icb_OpPSIMMessage_SetRequest ) ASN_Malloc( session, sizeof( struct Icb_OpPSIMMessage_SetRequest_t ) );
...
ASN_Result Icb_OpPSIMMessage_SetRequest_Decode( Icb_OpPSIMMessage_SetRequest ThisPtr, ASN_Session session, ASN_Stream stream )
{
  BOOL hasExtensions;
  ASN_Result result = ASN_RESULT_OK;
...
{
  Icb_OpWLANSTADisconnect_Response value = ( Icb_OpWLANSTADisconnect_Response ) ASN_Malloc( session, sizeof( struct Icb_OpWLANSTADisconnect_Response_t ) );
...
ASN_Result Icb_OpWLANSTADisconnect_Response_Decode( Icb_OpWLANSTADisconnect_Response ThisPtr, ASN_Session session, ASN_Stream stream )
{
  BOOL hasExtensions;
  ASN_Result result = ASN_RESULT_OK;
...
{
  Icb_OpWLANSTAForgetRememberedNetwk_SetRequest value = ( Icb_OpWLANSTAForgetRememberedNetwk_SetRequest ) ASN_Malloc( session, sizeof( struct Icb_OpWLANSTAForgetRememberedNetwk_SetRequest_t ) );
...
ASN_Result Icb_OpWLANSTAForgetRememberedNetwk_SetRequest_Decode( Icb_OpWLANSTAForgetRememberedNetwk_SetRequest ThisPtr, ASN_Session session, ASN_Stream stream )
{
  BOOL hasExtensions;
  ASN_Result result = ASN_RESULT_OK;
...
ASN_Result Icb_OpWLANSTAForgetRememberedNetwk_SetRequest_Encode( Icb_OpWLANSTAForgetRememberedNetwk_SetRequest ThisPtr, ASN_Stream stream)
{
  ASN_Result result = ASN_RESULT_OK;
...
{
  Icb_OpWLANSTAForgetRememberedNetwk_Response value = ( Icb_OpWLANSTAForgetRememberedNetwk_Response ) ASN_Malloc( session, sizeof( struct Icb_OpWLANSTAForgetRememberedNetwk_Response_t ) );
...
ASN_Result Icb_OpWLANSTAForgetRememberedNetwk_Response_Decode( Icb_OpWLANSTAForgetRememberedNetwk_Response ThisPtr, ASN_Session session, ASN_Stream stream )
{
  BOOL hasExtensions;
  ASN_Result result = ASN_RESULT_OK;
...
ASN_Result Icb_OpWLANSTAForgetRememberedNetwk_Response_Encode( Icb_OpWLANSTAForgetRememberedNetwk_Response ThisPtr, ASN_Stream stream)
{
  ASN_Result result = ASN_RESULT_OK;
...
{
  Icb_OpPSIMSecurity_Response value = ( Icb_OpPSIMSecurity_Response ) ASN_Malloc( session, sizeof( struct Icb_OpPSIMSecurity_Response_t ) );
...
ASN_Result Icb_OpPSIMSecurity_Response_Decode( Icb_OpPSIMSecurity_Response ThisPtr, ASN_Session session, ASN_Stream stream )
{
  BOOL hasExtensions;
  ASN_Result result = ASN_RESULT_OK;
...
{
  Icb_OpPSIMSignalStrength_Notification value = ( Icb_OpPSIMSignalStrength_Notification ) ASN_Malloc( session, sizeof( struct Icb_OpPSIMSignalStrength_Notification_t ) );
...
ASN_Result Icb_OpPSIMSignalStrength_Notification_Decode( Icb_OpPSIMSignalStrength_Notification ThisPtr, ASN_Session session, ASN_Stream stream )
{
  BOOL hasExtensions;
  ASN_Result result = ASN_RESULT_OK;
...
ASN_Result Icb_OpPSIMSignalStrength_Notification_Encode( Icb_OpPSIMSignalStrength_Notification ThisPtr, ASN_Stream stream)
{
  ASN_Result result = ASN_RESULT_OK;
...
{
  Icb_OpPremiumAudio_SetRequest value = ( Icb_OpPremiumAudio_SetRequest ) ASN_Malloc( session, sizeof( struct Icb_OpPremiumAudio_SetRequest_t ) );
...
ASN_Result Icb_OpPremiumAudio_SetRequest_Decode( Icb_OpPremiumAudio_SetRequest ThisPtr, ASN_Session session, ASN_Stream stream )
{
  BOOL hasExtensions;
  ASN_Result result = ASN_RESULT_OK;
...
{
  Icb_OpPremiumAudio_Response value = ( Icb_OpPremiumAudio_Response ) ASN_Malloc( session, sizeof( struct Icb_OpPremiumAudio_Response_t ) );
...
ASN_Result Icb_OpPremiumAudio_Response_Decode( Icb_OpPremiumAudio_Response ThisPtr, ASN_Session session, ASN_Stream stream )
{
  BOOL hasExtensions;
  ASN_Result result = ASN_RESULT_OK;
...
{
  Icb_OpDLCConnectedSignal_Response value = ( Icb_OpDLCConnectedSignal_Response ) ASN_Malloc( session, sizeof( struct Icb_OpDLCConnectedSignal_Response_t ) );
...
ASN_Result Icb_OpDLCConnectedSignal_Response_Decode( Icb_OpDLCConnectedSignal_Response ThisPtr, ASN_Session session, ASN_Stream stream )
{
  BOOL hasExtensions;
  ASN_Result result = ASN_RESULT_OK;
...
{
  Icb_NrOfSatellitesPerSystem value = ( Icb_NrOfSatellitesPerSystem ) ASN_Malloc( session, sizeof( struct Icb_NrOfSatellitesPerSystem_t ) );
...
ASN_Result Icb_NrOfSatellitesPerSystem_Decode( Icb_NrOfSatellitesPerSystem ThisPtr, ASN_Session session, ASN_Stream stream )
{
  BOOL hasExtensions;
  ASN_Result result = ASN_RESULT_OK;
...
#define ASN_INTERNAL_SIZE_Icb_ReceiverChannelData(max,min) { value->min_size = min; value->max_size = max; }
/*
...
{
  Icb_ReceiverChannelData value = ( Icb_ReceiverChannelData ) ASN_Malloc( session, sizeof( struct Icb_ReceiverChannelData_t ) );
...
{
  return sizeof( struct Icb_ReceiverChannelData_t ) + ASN_MAX( 0, 127 ) * ( sizeof( Icb_ChannelData ) + Icb_ChannelData_SessionSize(  ) );
}
#endif /* #ifdef ENABLE_ASN_SESSION_SIZE */
...
{
  if ( index < ThisPtr->min_size || index > ThisPtr->max_size )
    return ( Icb_ChannelData) NULL;
...
{
  Icb_ExtendedChannelData value = ( Icb_ExtendedChannelData ) ASN_Malloc( session, sizeof( struct Icb_ExtendedChannelData_t ) );
...
{
  Icb_ChannelCorrectionData value = ( Icb_ChannelCorrectionData ) ASN_Malloc( session, sizeof( struct Icb_ChannelCorrectionData_t ) );
...
{
  Icb_OpRemoteDiagnosticLink_Notification value = ( Icb_OpRemoteDiagnosticLink_Notification ) ASN_Malloc( session, sizeof( struct Icb_OpRemoteDiagnosticLink_Notification_t ) );
...
ASN_Result Icb_OpRemoteDiagnosticLink_Notification_Decode( Icb_OpRemoteDiagnosticLink_Notification ThisPtr, ASN_Session session, ASN_Stream stream )
{
  BOOL hasExtensions;
  ASN_Result result = ASN_RESULT_OK;
...
ASN_Result Icb_OpRemoteDiagnosticLink_Notification_Encode( Icb_OpRemoteDiagnosticLink_Notification ThisPtr, ASN_Stream stream)
{
  ASN_Result result = ASN_RESULT_OK;
...
{
  Icb_OpTextFromOperatorToUser_Notification value = ( Icb_OpTextFromOperatorToUser_Notification ) ASN_Malloc( session, sizeof( struct Icb_OpTextFromOperatorToUser_Notification_t ) );
...
ASN_Result Icb_OpTextFromOperatorToUser_Notification_Decode( Icb_OpTextFromOperatorToUser_Notification ThisPtr, ASN_Session session, ASN_Stream stream )
{
  BOOL hasExtensions;
  ASN_Result result = ASN_RESULT_OK;
...
ASN_Result Icb_OpTextFromOperatorToUser_Notification_Encode( Icb_OpTextFromOperatorToUser_Notification ThisPtr, ASN_Stream stream)
{
  ASN_Result result = ASN_RESULT_OK;
...
{
  Icb_OpCurrentJ2534Session_Notification value = ( Icb_OpCurrentJ2534Session_Notification ) ASN_Malloc( session, sizeof( struct Icb_OpCurrentJ2534Session_Notification_t ) );
...
ASN_Result Icb_OpCurrentJ2534Session_Notification_Decode( Icb_OpCurrentJ2534Session_Notification ThisPtr, ASN_Session session, ASN_Stream stream )
{
  BOOL hasExtensions;
  ASN_Result result = ASN_RESULT_OK;
...
ASN_Result Icb_OpCurrentJ2534Session_Notification_Encode( Icb_OpCurrentJ2534Session_Notification ThisPtr, ASN_Stream stream)
{
  ASN_Result result = ASN_RESULT_OK;
...
{
  Icb_OpRequestUserAuthentication_Request value = ( Icb_OpRequestUserAuthentication_Request ) ASN_Malloc( session, sizeof( struct Icb_OpRequestUserAuthentication_Request_t ) );
...
ASN_Result Icb_OpRequestUserAuthentication_Request_Decode( Icb_OpRequestUserAuthentication_Request ThisPtr, ASN_Session session, ASN_Stream stream )
{
  BOOL hasExtensions;
  ASN_Result result = ASN_RESULT_OK;
...
ASN_Result Icb_OpRequestUserAuthentication_Request_Encode( Icb_OpRequestUserAuthentication_Request ThisPtr, ASN_Stream stream)
{
  ASN_Result result = ASN_RESULT_OK;
...
{
  Icb_OpTextFromUserToOperator_Notification value = ( Icb_OpTextFromUserToOperator_Notification ) ASN_Malloc( session, sizeof( struct Icb_OpTextFromUserToOperator_Notification_t ) );
...
ASN_Result Icb_OpTextFromUserToOperator_Notification_Decode( Icb_OpTextFromUserToOperator_Notification ThisPtr, ASN_Session session, ASN_Stream stream )
{
  BOOL hasExtensions;
  ASN_Result result = ASN_RESULT_OK;
...
ASN_Result Icb_OpTextFromUserToOperator_Notification_Encode( Icb_OpTextFromUserToOperator_Notification ThisPtr, ASN_Stream stream)
{
  ASN_Result result = ASN_RESULT_OK;
...
{
  Icb_OpRequestRemoteDiagnostics_Notification value = ( Icb_OpRequestRemoteDiagnostics_Notification ) ASN_Malloc( session, sizeof( struct Icb_OpRequestRemoteDiagnostics_Notification_t ) );
...
ASN_Result Icb_OpRequestRemoteDiagnostics_Notification_Decode( Icb_OpRequestRemoteDiagnostics_Notification ThisPtr, ASN_Session session, ASN_Stream stream )
{
  BOOL hasExtensions;
  ASN_Result result = ASN_RESULT_OK;
...
ASN_Result Icb_OpRequestRemoteDiagnostics_Notification_Encode( Icb_OpRequestRemoteDiagnostics_Notification ThisPtr, ASN_Stream stream)
{
  ASN_Result result = ASN_RESULT_OK;
...
{
  Icb_OpAbortRemoteDiagnostics_Notification value = ( Icb_OpAbortRemoteDiagnostics_Notification ) ASN_Malloc( session, sizeof( struct Icb_OpAbortRemoteDiagnostics_Notification_t ) );
...
ASN_Result Icb_OpAbortRemoteDiagnostics_Notification_Decode( Icb_OpAbortRemoteDiagnostics_Notification ThisPtr, ASN_Session session, ASN_Stream stream )
{
  BOOL hasExtensions;
  ASN_Result result = ASN_RESULT_OK;
...
ASN_Result Icb_OpAbortRemoteDiagnostics_Notification_Encode( Icb_OpAbortRemoteDiagnostics_Notification ThisPtr, ASN_Stream stream)
{
  ASN_Result result = ASN_RESULT_OK;
...
{
  Icb_OpCancelDownload_SetRequest value = ( Icb_OpCancelDownload_SetRequest ) ASN_Malloc( session, sizeof( struct Icb_OpCancelDownload_SetRequest_t ) );
...
ASN_Result Icb_OpCancelDownload_SetRequest_Decode( Icb_OpCancelDownload_SetRequest ThisPtr, ASN_Session session, ASN_Stream stream )
{
  ASN_Result result = ASN_RESULT_OK;
...
{
  Icb_OpCancelDownload_Response value = ( Icb_OpCancelDownload_Response ) ASN_Malloc( session, sizeof( struct Icb_OpCancelDownload_Response_t ) );
...
ASN_Result Icb_OpCancelDownload_Response_Decode( Icb_OpCancelDownload_Response ThisPtr, ASN_Session session, ASN_Stream stream )
{
  ASN_Result result = ASN_RESULT_OK;
...
{
  Icb_OpLocalStorage_Response value = ( Icb_OpLocalStorage_Response ) ASN_Malloc( session, sizeof( struct Icb_OpLocalStorage_Response_t ) );
...
ASN_Result Icb_OpLocalStorage_Response_Decode( Icb_OpLocalStorage_Response ThisPtr, ASN_Session session, ASN_Stream stream )
{
  BOOL hasExtensions;
  ASN_Result result = ASN_RESULT_OK;
...
{
  Icb_OpTvmVehicleInfo_Response value = ( Icb_OpTvmVehicleInfo_Response ) ASN_Malloc( session, sizeof( struct Icb_OpTvmVehicleInfo_Response_t ) );
...
ASN_Result Icb_OpTvmVehicleInfo_Response_Decode( Icb_OpTvmVehicleInfo_Response ThisPtr, ASN_Session session, ASN_Stream stream )
{
  BOOL hasExtensions;
  ASN_Result result = ASN_RESULT_OK;
...
{
  Icb_OpTvmVehicleInfo_Notification value = ( Icb_OpTvmVehicleInfo_Notification ) ASN_Malloc( session, sizeof( struct Icb_OpTvmVehicleInfo_Notification_t ) );
...
ASN_Result Icb_OpTvmVehicleInfo_Notification_Decode( Icb_OpTvmVehicleInfo_Notification ThisPtr, ASN_Session session, ASN_Stream stream )
{
  BOOL hasExtensions;
  ASN_Result result = ASN_RESULT_OK;
...
{
  Icb_ArrayOf_ClimateTimer value = ( Icb_ArrayOf_ClimateTimer ) ASN_Malloc( session, sizeof( struct Icb_ArrayOf_ClimateTimer_t ) );
...
{
  return sizeof( struct Icb_ArrayOf_ClimateTimer_t ) + max * ( sizeof( Icb_ClimateTimer ) + Icb_ClimateTimer_SessionSize(  ) );
}
#endif /* #ifdef ENABLE_ASN_SESSION_SIZE */
...
ASN_Result Icb_ArrayOf_ClimateTimer_Decode( Icb_ArrayOf_ClimateTimer ThisPtr, ASN_Session session,  ASN_Stream stream, S32 min, S32 max)
{
  ASN_Result result = ASN_RESULT_OK;
  U32 i;
...
ASN_Result Icb_ArrayOf_OnOff_Decode( Icb_ArrayOf_OnOff ThisPtr, ASN_Session session,  ASN_Stream stream, S32 min, S32 max)
{
  ASN_Result result = ASN_RESULT_OK;
  U32 i;
  ASN_DECODE_CHECK( U32_Decode( &ThisPtr->actual_size, session, stream, min, max ) );
...
#define ASN_INTERNAL_SIZE_Icb_OpGenericSettingSynch_Request_settingIDs(max,min) { value->min_size = min; value->max_size = max; }
/*
...
{
  Icb_OpGenericSettingSynch_Request_settingIDs value = ( Icb_OpGenericSettingSynch_Request_settingIDs ) ASN_Malloc( session, sizeof( struct Icb_OpGenericSettingSynch_Request_settingIDs_t ) );
...
{
  return sizeof( struct Icb_OpGenericSettingSynch_Request_settingIDs_t ) + ASN_MAX( 0, 50 ) * ( sizeof( U32 ) + U32_SessionSize( 0, 65535 ) );
}
#endif /* #ifdef ENABLE_ASN_SESSION_SIZE */

ASN_Result Icb_OpGenericSettingSynch_Request_settingIDs_Encode( Icb_OpGenericSettingSynch_Request_settingIDs ThisPtr, ASN_Stream stream )
{
  ASN_Result result = ASN_RESULT_OK;
  U32 i;
...
ASN_Result Icb_OpGenericSettingSynch_Request_settingIDs_SetSize( Icb_OpGenericSettingSynch_Request_settingIDs ThisPtr, ASN_Session session, U32 size )
{
  ASN_Result result = ASN_RESULT_OK;
  U32 i;
...
ASN_Result Icb_OpGenericSettingSynch_Request_settingIDs_Decode( Icb_OpGenericSettingSynch_Request_settingIDs ThisPtr, ASN_Session session,  ASN_Stream stream )
{
  ASN_Result result = ASN_RESULT_OK;
  U32 i;
...
U32 Icb_OpGenericSettingSynch_Request_settingIDs_GetIndex( Icb_OpGenericSettingSynch_Request_settingIDs ThisPtr, U32 index)
{
  if ( index < ThisPtr->min_size || index > ThisPtr->max_size )
    return ( U32) NULL;
  return ThisPtr->data_array[ index ];
...
{
  U32 i;
  ASN_PrintIndented( "Icb_OpGenericSettingSynch_Request_settingIDs,Size = %lu" EOL, ( unsigned long)ThisPtr->actual_size );
  ASN_PrintSetIndent( 1 );
  for ( i = 0; i < ThisPtr->actual_size; i++)
  {
...
ASN_Result Icb_ArrayOf_Setting_Decode( Icb_ArrayOf_Setting ThisPtr, ASN_Session session,  ASN_Stream stream, S32 min, S32 max)
{
  ASN_Result result = ASN_RESULT_OK;
  U32 i;
  ASN_DECODE_CHECK( U32_Decode( &ThisPtr->actual_size, session, stream, min, max ) );
...
ASN_Result Icb_ArrayOf_SBWarning_Decode( Icb_ArrayOf_SBWarning ThisPtr, ASN_Session session,  ASN_Stream stream, S32 min, S32 max)
{
  ASN_Result result = ASN_RESULT_OK;
  U32 i;
  ASN_DECODE_CHECK( U32_Decode( &ThisPtr->actual_size, session, stream, min, max ) );
...
{
  Icb_ArrayOf_WLANFrequencyBand value = ( Icb_ArrayOf_WLANFrequencyBand ) ASN_Malloc( session, sizeof( struct Icb_ArrayOf_WLANFrequencyBand_t ) );
...
{
  return sizeof( struct Icb_ArrayOf_WLANFrequencyBand_t ) + max * ( sizeof( Icb_WLANFrequencyBand ) + Icb_WLANFrequencyBand_SessionSize(  ) );
}
#endif /* #ifdef ENABLE_ASN_SESSION_SIZE */

ASN_Result Icb_ArrayOf_WLANFrequencyBand_Encode( Icb_ArrayOf_WLANFrequencyBand ThisPtr, ASN_Stream stream, S32 min, S32 max)
{
  ASN_Result result = ASN_RESULT_OK;
  U32 i;
  ASN_ENCODE_CHECK( U32_Encode( ThisPtr->actual_size, stream, min, max ) );
...
ASN_Result Icb_ArrayOf_WLANFrequencyBand_Decode( Icb_ArrayOf_WLANFrequencyBand ThisPtr, ASN_Session session,  ASN_Stream stream, S32 min, S32 max)
{
  ASN_Result result = ASN_RESULT_OK;
  U32 i;
  ASN_DECODE_CHECK( U32_Decode( &ThisPtr->actual_size, session, stream, min, max ) );
...
{
  if ( index < ThisPtr->min_size || index > ThisPtr->max_size )
    return ( Icb_WLANFrequencyBand) NULL;
  return ThisPtr->data_array[ index ];
}
#ifdef ASN_PRINT
...
{
  Icb_ArrayOf_WLANConnDevice value = ( Icb_ArrayOf_WLANConnDevice ) ASN_Malloc( session, sizeof( struct Icb_ArrayOf_WLANConnDevice_t ) );
...
{
  return sizeof( struct Icb_ArrayOf_WLANConnDevice_t ) + max * ( sizeof( Icb_WLANConnDevice ) + Icb_WLANConnDevice_SessionSize(  ) );
}
#endif /* #ifdef ENABLE_ASN_SESSION_SIZE */
...
ASN_Result Icb_ArrayOf_WLANConnDevice_Decode( Icb_ArrayOf_WLANConnDevice ThisPtr, ASN_Session session,  ASN_Stream stream, S32 min, S32 max)
{
  ASN_Result result = ASN_RESULT_OK;
  U32 i;
  ASN_DECODE_CHECK( U32_Decode( &ThisPtr->actual_size, session, stream, min, max ) );
...
{
  if ( index < ThisPtr->min_size || index > ThisPtr->max_size )
    return ( Icb_WLANConnDevice) NULL;
  return ThisPtr->data_array[ index ];
}
#ifdef ASN_PRINT
...
{
  Icb_ArrayOf_AvailableNetworkInformation value = ( Icb_ArrayOf_AvailableNetworkInformation ) ASN_Malloc( session, sizeof( struct Icb_ArrayOf_AvailableNetworkInformation_t ) );
...
U32 Icb_ArrayOf_AvailableNetworkInformation_EncodedSize( Icb_ArrayOf_AvailableNetworkInformation ThisPtr, S32 min, S32 max)
{
  U32 i;
  U32 length = ASN_U32CountBits(min, max);
  for ( i = 0; i < ThisPtr->actual_size; i++ )
...
{
  return sizeof( struct Icb_ArrayOf_AvailableNetworkInformation_t ) + max * ( sizeof( Icb_AvailableNetworkInformation ) + Icb_AvailableNetworkInformation_SessionSize(  ) );
}
#endif /* #ifdef ENABLE_ASN_SESSION_SIZE */

ASN_Result Icb_ArrayOf_AvailableNetworkInformation_Encode( Icb_ArrayOf_AvailableNetworkInformation ThisPtr, ASN_Stream stream, S32 min, S32 max)
{
  ASN_Result result = ASN_RESULT_OK;
  U32 i;
  ASN_ENCODE_CHECK( U32_Encode( ThisPtr->actual_size, stream, min, max ) );
...
ASN_Result Icb_ArrayOf_AvailableNetworkInformation_SetSize( Icb_ArrayOf_AvailableNetworkInformation ThisPtr, ASN_Session session, U32 size )
{
  ASN_Result result = ASN_RESULT_OK;
  U32 i;
...
ASN_Result Icb_ArrayOf_AvailableNetworkInformation_Decode( Icb_ArrayOf_AvailableNetworkInformation ThisPtr, ASN_Session session,  ASN_Stream stream, S32 min, S32 max)
{
  ASN_Result result = ASN_RESULT_OK;
  U32 i;
  ASN_DECODE_CHECK( U32_Decode( &ThisPtr->actual_size, session, stream, min, max ) );
...
Icb_AvailableNetworkInformation Icb_ArrayOf_AvailableNetworkInformation_GetIndex( Icb_ArrayOf_AvailableNetworkInformation ThisPtr, U32 index)
{
  if ( index < ThisPtr->min_size || index > ThisPtr->max_size )
    return ( Icb_AvailableNetworkInformation) NULL;
  return ThisPtr->data_array[ index ];
}
#ifdef ASN_PRINT
...
{
  Icb_ArrayOf_NetworkOperator value = ( Icb_ArrayOf_NetworkOperator ) ASN_Malloc( session, sizeof( struct Icb_ArrayOf_NetworkOperator_t ) );
...
{
  return sizeof( struct Icb_ArrayOf_NetworkOperator_t ) + max * ( sizeof( Icb_NetworkOperator ) + Icb_NetworkOperator_SessionSize(  ) );
}
#endif /* #ifdef ENABLE_ASN_SESSION_SIZE */

ASN_Result Icb_ArrayOf_NetworkOperator_Encode( Icb_ArrayOf_NetworkOperator ThisPtr, ASN_Stream stream, S32 min, S32 max)
{
  ASN_Result result = ASN_RESULT_OK;
  U32 i;
  ASN_ENCODE_CHECK( U32_Encode( ThisPtr->actual_size, stream, min, max ) );
...
ASN_Result Icb_ArrayOf_NetworkOperator_Decode( Icb_ArrayOf_NetworkOperator ThisPtr, ASN_Session session,  ASN_Stream stream, S32 min, S32 max)
{
  ASN_Result result = ASN_RESULT_OK;
  U32 i;
  ASN_DECODE_CHECK( U32_Decode( &ThisPtr->actual_size, session, stream, min, max ) );
...
{
  if ( index < ThisPtr->min_size || index > ThisPtr->max_size )
    return ( Icb_NetworkOperator) NULL;
  return ThisPtr->data_array[ index ];
}
#ifdef ASN_PRINT
...
{
  Icb_ArrayOf_RadioFrequencyHz value = ( Icb_ArrayOf_RadioFrequencyHz ) ASN_Malloc( session, sizeof( struct Icb_ArrayOf_RadioFrequencyHz_t ) );
...
{
  return sizeof( struct Icb_ArrayOf_RadioFrequencyHz_t ) + max * ( sizeof( Icb_RadioFrequencyHz ) + Icb_RadioFrequencyHz_SessionSize(  ) );
}
#endif /* #ifdef ENABLE_ASN_SESSION_SIZE */

ASN_Result Icb_ArrayOf_RadioFrequencyHz_Encode( Icb_ArrayOf_RadioFrequencyHz ThisPtr, ASN_Stream stream, S32 min, S32 max)
{
  ASN_Result result = ASN_RESULT_OK;
  U32 i;
  ASN_ENCODE_CHECK( U32_Encode( ThisPtr->actual_size, stream, min, max ) );
...
ASN_Result Icb_ArrayOf_RadioFrequencyHz_Decode( Icb_ArrayOf_RadioFrequencyHz ThisPtr, ASN_Session session,  ASN_Stream stream, S32 min, S32 max)
{
  ASN_Result result = ASN_RESULT_OK;
  U32 i;
  ASN_DECODE_CHECK( U32_Decode( &ThisPtr->actual_size, session, stream, min, max ) );
...
{
  if ( index < ThisPtr->min_size || index > ThisPtr->max_size )
    return ( Icb_RadioFrequencyHz) NULL;
  return ThisPtr->data_array[ index ];
}
#ifdef ASN_PRINT
...
{
  Icb_ArrayOf_ApprovalStatusType value = ( Icb_ArrayOf_ApprovalStatusType ) ASN_Malloc( session, sizeof( struct Icb_ArrayOf_ApprovalStatusType_t ) );
...
{
  return sizeof( struct Icb_ArrayOf_ApprovalStatusType_t ) + max * ( sizeof( Icb_ApprovalStatusType ) + Icb_ApprovalStatusType_SessionSize(  ) );
}
#endif /* #ifdef ENABLE_ASN_SESSION_SIZE */

ASN_Result Icb_ArrayOf_ApprovalStatusType_Encode( Icb_ArrayOf_ApprovalStatusType ThisPtr, ASN_Stream stream, S32 min, S32 max)
{
  ASN_Result result = ASN_RESULT_OK;
  U32 i;
  ASN_ENCODE_CHECK( U32_Encode( ThisPtr->actual_size, stream, min, max ) );
...
ASN_Result Icb_ArrayOf_ApprovalStatusType_SetSize( Icb_ArrayOf_ApprovalStatusType ThisPtr, ASN_Session session, U32 size )
{
  ASN_Result result = ASN_RESULT_OK;
  U32 i;
...
ASN_Result Icb_ArrayOf_ApprovalStatusType_Decode( Icb_ArrayOf_ApprovalStatusType ThisPtr, ASN_Session session,  ASN_Stream stream, S32 min, S32 max)
{
  ASN_Result result = ASN_RESULT_OK;
  U32 i;
  ASN_DECODE_CHECK( U32_Decode( &ThisPtr->actual_size, session, stream, min, max ) );
...
{
  if ( index < ThisPtr->min_size || index > ThisPtr->max_size )
    return ( Icb_ApprovalStatusType) NULL;
  return ThisPtr->data_array[ index ];
}
#ifdef ASN_PRINT
...
{
  Icb_ArrayOf_SoftwareProduct value = ( Icb_ArrayOf_SoftwareProduct ) ASN_Malloc( session, sizeof( struct Icb_ArrayOf_SoftwareProduct_t ) );
...
{
  return sizeof( struct Icb_ArrayOf_SoftwareProduct_t ) + max * ( sizeof( Icb_SoftwareProduct ) + Icb_SoftwareProduct_SessionSize(  ) );
}
#endif /* #ifdef ENABLE_ASN_SESSION_SIZE */

ASN_Result Icb_ArrayOf_SoftwareProduct_Encode( Icb_ArrayOf_SoftwareProduct ThisPtr, ASN_Stream stream, S32 min, S32 max)
{
  ASN_Result result = ASN_RESULT_OK;
  U32 i;
  ASN_ENCODE_CHECK( U32_Encode( ThisPtr->actual_size, stream, min, max ) );
...
ASN_Result Icb_ArrayOf_SoftwareProduct_Decode( Icb_ArrayOf_SoftwareProduct ThisPtr, ASN_Session session,  ASN_Stream stream, S32 min, S32 max)
{
  ASN_Result result = ASN_RESULT_OK;
  U32 i;
  ASN_DECODE_CHECK( U32_Decode( &ThisPtr->actual_size, session, stream, min, max ) );
...
{
  if ( index < ThisPtr->min_size || index > ThisPtr->max_size )
    return ( Icb_SoftwareProduct) NULL;
  return ThisPtr->data_array[ index ];
}
#ifdef ASN_PRINT
...
{
  Icb_ArrayOf_PartIdentifier value = ( Icb_ArrayOf_PartIdentifier ) ASN_Malloc( session, sizeof( struct Icb_ArrayOf_PartIdentifier_t ) );
...
{
  return sizeof( struct Icb_ArrayOf_PartIdentifier_t ) + max * ( sizeof( Icb_PartIdentifier ) + Icb_PartIdentifier_SessionSize(  ) );
}
#endif /* #ifdef ENABLE_ASN_SESSION_SIZE */
...
ASN_Result Icb_ArrayOf_PartIdentifier_Decode( Icb_ArrayOf_PartIdentifier ThisPtr, ASN_Session session,  ASN_Stream stream, S32 min, S32 max)
{
  ASN_Result result = ASN_RESULT_OK;
  U32 i;
  ASN_DECODE_CHECK( U32_Decode( &ThisPtr->actual_size, session, stream, min, max ) );
...
{
  if ( index < ThisPtr->min_size || index > ThisPtr->max_size )
    return ( Icb_PartIdentifier) NULL;
  return ThisPtr->data_array[ index ];
}
#ifdef ASN_PRINT
...
{
  Icb_ArrayOf_InstallationData value = ( Icb_ArrayOf_InstallationData ) ASN_Malloc( session, sizeof( struct Icb_ArrayOf_InstallationData_t ) );
...
{
  return sizeof( struct Icb_ArrayOf_InstallationData_t ) + max * ( sizeof( Icb_InstallationData ) + Icb_InstallationData_SessionSize(  ) );
}
#endif /* #ifdef ENABLE_ASN_SESSION_SIZE */

ASN_Result Icb_ArrayOf_InstallationData_Encode( Icb_ArrayOf_InstallationData ThisPtr, ASN_Stream stream, S32 min, S32 max)
{
  ASN_Result result = ASN_RESULT_OK;
  U32 i;
  ASN_ENCODE_CHECK( U32_Encode( ThisPtr->actual_size, stream, min, max ) );
...
ASN_Result Icb_ArrayOf_InstallationData_Decode( Icb_ArrayOf_InstallationData ThisPtr, ASN_Session session,  ASN_Stream stream, S32 min, S32 max)
{
  ASN_Result result = ASN_RESULT_OK;
  U32 i;
  ASN_DECODE_CHECK( U32_Decode( &ThisPtr->actual_size, session, stream, min, max ) );
...
{
  if ( index < ThisPtr->min_size || index > ThisPtr->max_size )
    return ( Icb_InstallationData) NULL;
  return ThisPtr->data_array[ index ];
}
#ifdef ASN_PRINT
...
{
  Icb_ArrayOf_InstalledData value = ( Icb_ArrayOf_InstalledData ) ASN_Malloc( session, sizeof( struct Icb_ArrayOf_InstalledData_t ) );
...
{
  return sizeof( struct Icb_ArrayOf_InstalledData_t ) + max * ( sizeof( Icb_InstalledData ) + Icb_InstalledData_SessionSize(  ) );
}
#endif /* #ifdef ENABLE_ASN_SESSION_SIZE */
...
ASN_Result Icb_ArrayOf_InstalledData_Decode( Icb_ArrayOf_InstalledData ThisPtr, ASN_Session session,  ASN_Stream stream, S32 min, S32 max)
{
  ASN_Result result = ASN_RESULT_OK;
  U32 i;
  ASN_DECODE_CHECK( U32_Decode( &ThisPtr->actual_size, session, stream, min, max ) );
...
{
  Icb_OpTelematicSettings_SetRequest value = ( Icb_OpTelematicSettings_SetRequest ) ASN_Malloc( session, sizeof( struct Icb_OpTelematicSettings_SetRequest_t ) );
...
ASN_Result Icb_OpTelematicSettings_SetRequest_Decode( Icb_OpTelematicSettings_SetRequest ThisPtr, ASN_Session session, ASN_Stream stream )
{
  BOOL hasExtensions;
  ASN_Result result = ASN_RESULT_OK;
...
{
  Icb_OpTelematicSettings_Response value = ( Icb_OpTelematicSettings_Response ) ASN_Malloc( session, sizeof( struct Icb_OpTelematicSettings_Response_t ) );
...
ASN_Result Icb_OpTelematicSettings_Response_Decode( Icb_OpTelematicSettings_Response ThisPtr, ASN_Session session, ASN_Stream stream )
{
  BOOL hasExtensions;
  ASN_Result result = ASN_RESULT_OK;
...
{
  Icb_OpPositionData_Response value = ( Icb_OpPositionData_Response ) ASN_Malloc( session, sizeof( struct Icb_OpPositionData_Response_t ) );
...
ASN_Result Icb_OpPositionData_Response_Decode( Icb_OpPositionData_Response ThisPtr, ASN_Session session, ASN_Stream stream )
{
  BOOL hasExtensions;
  ASN_Result result = ASN_RESULT_OK;
...
{
  Icb_WGS84SimplePositionData value = ( Icb_WGS84SimplePositionData ) ASN_Malloc( session, sizeof( struct Icb_WGS84SimplePositionData_t ) );
...
ASN_Result Icb_WGS84SimplePositionData_Decode( Icb_WGS84SimplePositionData ThisPtr, ASN_Session session, ASN_Stream stream )
{
  BOOL hasExtensions;
  ASN_Result result = ASN_RESULT_OK;
...
{
  Icb_OpSubscriptionActivation_SetRequest value = ( Icb_OpSubscriptionActivation_SetRequest ) ASN_Malloc( session, sizeof( struct Icb_OpSubscriptionActivation_SetRequest_t ) );
...
ASN_Result Icb_OpSubscriptionActivation_SetRequest_Decode( Icb_OpSubscriptionActivation_SetRequest ThisPtr, ASN_Session session, ASN_Stream stream )
{
  BOOL hasExtensions;
  ASN_Result result = ASN_RESULT_OK;
...
ASN_Result Icb_OpSubscriptionActivation_SetRequest_Encode( Icb_OpSubscriptionActivation_SetRequest ThisPtr, ASN_Stream stream)
{
  ASN_Result result = ASN_RESULT_OK;
...
{
  Icb_OpSubscriptionActivation_Response value = ( Icb_OpSubscriptionActivation_Response ) ASN_Malloc( session, sizeof( struct Icb_OpSubscriptionActivation_Response_t ) );
...
ASN_Result Icb_OpSubscriptionActivation_Response_Decode( Icb_OpSubscriptionActivation_Response ThisPtr, ASN_Session session, ASN_Stream stream )
{
  BOOL hasExtensions;
  ASN_Result result = ASN_RESULT_OK;
...
ASN_Result Icb_OpSubscriptionActivation_Response_Encode( Icb_OpSubscriptionActivation_Response ThisPtr, ASN_Stream stream)
{
  ASN_Result result = ASN_RESULT_OK;
...
{
  Icb_OpSubscriptionActivation_Notification value = ( Icb_OpSubscriptionActivation_Notification ) ASN_Malloc( session, sizeof( struct Icb_OpSubscriptionActivation_Notification_t ) );
...
ASN_Result Icb_OpSubscriptionActivation_Notification_Decode( Icb_OpSubscriptionActivation_Notification ThisPtr, ASN_Session session, ASN_Stream stream )
{
  BOOL hasExtensions;
  ASN_Result result = ASN_RESULT_OK;
...
ASN_Result Icb_OpSubscriptionActivation_Notification_Encode( Icb_OpSubscriptionActivation_Notification ThisPtr, ASN_Stream stream)
{
  ASN_Result result = ASN_RESULT_OK;
...
{
  Icb_OpServiceActivation_SetRequest value = ( Icb_OpServiceActivation_SetRequest ) ASN_Malloc( session, sizeof( struct Icb_OpServiceActivation_SetRequest_t ) );
...
ASN_Result Icb_OpServiceActivation_SetRequest_Decode( Icb_OpServiceActivation_SetRequest ThisPtr, ASN_Session session, ASN_Stream stream )
{
  BOOL hasExtensions;
  ASN_Result result = ASN_RESULT_OK;
...
{
  Icb_OpRescueStatus_Response value = ( Icb_OpRescueStatus_Response ) ASN_Malloc( session, sizeof( struct Icb_OpRescueStatus_Response_t ) );
...
ASN_Result Icb_OpRescueStatus_Response_Decode( Icb_OpRescueStatus_Response ThisPtr, ASN_Session session, ASN_Stream stream )
{
  BOOL hasExtensions;
  ASN_Result result = ASN_RESULT_OK;
...
{
  Icb_OpRescueStatus_Notification value = ( Icb_OpRescueStatus_Notification ) ASN_Malloc( session, sizeof( struct Icb_OpRescueStatus_Notification_t ) );
...
ASN_Result Icb_OpRescueStatus_Notification_Decode( Icb_OpRescueStatus_Notification ThisPtr, ASN_Session session, ASN_Stream stream )
{
  BOOL hasExtensions;
  ASN_Result result = ASN_RESULT_OK;
...
{
  Icb_OpSendToCarConfirmation_SetRequest value = ( Icb_OpSendToCarConfirmation_SetRequest ) ASN_Malloc( session, sizeof( struct Icb_OpSendToCarConfirmation_SetRequest_t ) );
...
ASN_Result Icb_OpSendToCarConfirmation_SetRequest_Decode( Icb_OpSendToCarConfirmation_SetRequest ThisPtr, ASN_Session session, ASN_Stream stream )
{
  BOOL hasExtensions;
  ASN_Result result = ASN_RESULT_OK;
...
ASN_Result Icb_OpSendToCarConfirmation_SetRequest_Encode( Icb_OpSendToCarConfirmation_SetRequest ThisPtr, ASN_Stream stream)
{
  ASN_Result result = ASN_RESULT_OK;
...
{
  Icb_OpSendToCarConfirmation_Response value = ( Icb_OpSendToCarConfirmation_Response ) ASN_Malloc( session, sizeof( struct Icb_OpSendToCarConfirmation_Response_t ) );
...
ASN_Result Icb_OpSendToCarConfirmation_Response_Decode( Icb_OpSendToCarConfirmation_Response ThisPtr, ASN_Session session, ASN_Stream stream )
{
  BOOL hasExtensions;
  ASN_Result result = ASN_RESULT_OK;
...
{
  Icb_OpSendToCar_SetRequest value = ( Icb_OpSendToCar_SetRequest ) ASN_Malloc( session, sizeof( struct Icb_OpSendToCar_SetRequest_t ) );
...
ASN_Result Icb_OpSendToCar_SetRequest_Decode( Icb_OpSendToCar_SetRequest ThisPtr, ASN_Session session, ASN_Stream stream )
{
  BOOL hasExtensions;
  ASN_Result result = ASN_RESULT_OK;
...
{
  Icb_OpUserPrivacySettings_Notification value = ( Icb_OpUserPrivacySettings_Notification ) ASN_Malloc( session, sizeof( struct Icb_OpUserPrivacySettings_Notification_t ) );
...
ASN_Result Icb_OpUserPrivacySettings_Notification_Decode( Icb_OpUserPrivacySettings_Notification ThisPtr, ASN_Session session, ASN_Stream stream )
{
  BOOL hasExtensions;
  ASN_Result result = ASN_RESULT_OK;
...
ASN_Result Icb_OpUserPrivacySettings_Notification_Encode( Icb_OpUserPrivacySettings_Notification ThisPtr, ASN_Stream stream)
{
  ASN_Result result = ASN_RESULT_OK;
...
{
  Icb_OpClimateTimers_SetRequest value = ( Icb_OpClimateTimers_SetRequest ) ASN_Malloc( session, sizeof( struct Icb_OpClimateTimers_SetRequest_t ) );
...
ASN_Result Icb_OpClimateTimers_SetRequest_Decode( Icb_OpClimateTimers_SetRequest ThisPtr, ASN_Session session, ASN_Stream stream )
{
  ASN_Result result = ASN_RESULT_OK;
...
{
  Icb_OpClimateTimers_Response value = ( Icb_OpClimateTimers_Response ) ASN_Malloc( session, sizeof( struct Icb_OpClimateTimers_Response_t ) );
...
ASN_Result Icb_OpClimateTimers_Response_Decode( Icb_OpClimateTimers_Response ThisPtr, ASN_Session session, ASN_Stream stream )
{
  ASN_Result result = ASN_RESULT_OK;
  ASN_DECODE_CHECK( Icb_DateTime_Decode( ThisPtr->timestamp, session, stream ) );
  ASN_DECODE_CHECK( Icb_ArrayOf_ClimateTimer_Decode( ThisPtr->timers, session, stream, 0, 31 ) );
...
{
  Icb_OpGenericSettingSynch_Request value = ( Icb_OpGenericSettingSynch_Request ) ASN_Malloc( session, sizeof( struct Icb_OpGenericSettingSynch_Request_t ) );
...
ASN_Result Icb_OpGenericSettingSynch_Request_Decode( Icb_OpGenericSettingSynch_Request ThisPtr, ASN_Session session, ASN_Stream stream )
{
  ASN_Result result = ASN_RESULT_OK;
...
{
  Icb_OpGenericSettingSynch_SetRequest value = ( Icb_OpGenericSettingSynch_SetRequest ) ASN_Malloc( session, sizeof( struct Icb_OpGenericSettingSynch_SetRequest_t ) );
...
ASN_Result Icb_OpGenericSettingSynch_SetRequest_Decode( Icb_OpGenericSettingSynch_SetRequest ThisPtr, ASN_Session session, ASN_Stream stream )
{
  ASN_Result result = ASN_RESULT_OK;
  ASN_DECODE_CHECK( Icb_DateTime_Decode( ThisPtr->time, session, stream ) );
...
{
  Icb_OpGenericSettingSynch_Response value = ( Icb_OpGenericSettingSynch_Response ) ASN_Malloc( session, sizeof( struct Icb_OpGenericSettingSynch_Response_t ) );
...
ASN_Result Icb_OpGenericSettingSynch_Response_Decode( Icb_OpGenericSettingSynch_Response ThisPtr, ASN_Session session, ASN_Stream stream )
{
  ASN_Result result = ASN_RESULT_OK;
  ASN_DECODE_CHECK( Icb_DateTime_Decode( ThisPtr->time, session, stream ) );
  ASN_DECODE_CHECK( Icb_ArrayOf_Setting_Decode( ThisPtr->settings, session, stream, 0, 50 ) );
...
{
  Icb_OpGenericSettingSynch_Notification value = ( Icb_OpGenericSettingSynch_Notification ) ASN_Malloc( session, sizeof( struct Icb_OpGenericSettingSynch_Notification_t ) );
...
ASN_Result Icb_OpGenericSettingSynch_Notification_Decode( Icb_OpGenericSettingSynch_Notification ThisPtr, ASN_Session session, ASN_Stream stream )
{
  ASN_Result result = ASN_RESULT_OK;
  ASN_DECODE_CHECK( Icb_DateTime_Decode( ThisPtr->time, session, stream ) );
  ASN_DECODE_CHECK( Icb_ArrayOf_Setting_Decode( ThisPtr->settings, session, stream, 0, 50 ) );
...
ASN_Result Icb_OpGenericSettingSynch_Notification_Encode( Icb_OpGenericSettingSynch_Notification ThisPtr, ASN_Stream stream)
{
  ASN_Result result = ASN_RESULT_OK;
  ASN_ENCODE_CHECK( Icb_DateTime_Encode( ThisPtr->time, stream) );
  ASN_ENCODE_CHECK( Icb_ArrayOf_Setting_Encode( ThisPtr->settings, stream, 0, 50) );
...
{
  Icb_OpSoHPacketSend_SetRequestNoReturn value = ( Icb_OpSoHPacketSend_SetRequestNoReturn ) ASN_Malloc( session, sizeof( struct Icb_OpSoHPacketSend_SetRequestNoReturn_t ) );
...
ASN_Result Icb_OpSoHPacketSend_SetRequestNoReturn_Decode( Icb_OpSoHPacketSend_SetRequestNoReturn ThisPtr, ASN_Session session, ASN_Stream stream )
{
  ASN_Result result = ASN_RESULT_OK;
  ASN_DECODE_CHECK( BOOL_Decode( &ThisPtr->exists__optional__sbText, session, stream ) );
...
ASN_Result Icb_OpSoHPacketSend_SetRequestNoReturn_Encode( Icb_OpSoHPacketSend_SetRequestNoReturn ThisPtr, ASN_Stream stream)
{
  ASN_Result result = ASN_RESULT_OK;
  ASN_ENCODE_CHECK( BOOL_Encode( ThisPtr->exists__optional__sbText, stream) );
...
{
  Icb_OpPSIMDataCounter_Response value = ( Icb_OpPSIMDataCounter_Response ) ASN_Malloc( session, sizeof( struct Icb_OpPSIMDataCounter_Response_t ) );
...
ASN_Result Icb_OpPSIMDataCounter_Response_Decode( Icb_OpPSIMDataCounter_Response ThisPtr, ASN_Session session, ASN_Stream stream )
{
  BOOL hasExtensions;
  ASN_Result result = ASN_RESULT_OK;
...
{
  Icb_OpPSIMNetworkConfiguration_SetRequest value = ( Icb_OpPSIMNetworkConfiguration_SetRequest ) ASN_Malloc( session, sizeof( struct Icb_OpPSIMNetworkConfiguration_SetRequest_t ) );
...
ASN_Result Icb_OpPSIMNetworkConfiguration_SetRequest_Decode( Icb_OpPSIMNetworkConfiguration_SetRequest ThisPtr, ASN_Session session, ASN_Stream stream )
{
  BOOL hasExtensions;
  ASN_Result result = ASN_RESULT_OK;
...
ASN_Result Icb_OpPSIMNetworkConfiguration_SetRequest_Encode( Icb_OpPSIMNetworkConfiguration_SetRequest ThisPtr, ASN_Stream stream)
{
  ASN_Result result = ASN_RESULT_OK;
...
{
  Icb_OpPSIMNetworkConfiguration_Response value = ( Icb_OpPSIMNetworkConfiguration_Response ) ASN_Malloc( session, sizeof( struct Icb_OpPSIMNetworkConfiguration_Response_t ) );
...
ASN_Result Icb_OpPSIMNetworkConfiguration_Response_Decode( Icb_OpPSIMNetworkConfiguration_Response ThisPtr, ASN_Session session, ASN_Stream stream )
{
  BOOL hasExtensions;
  ASN_Result result = ASN_RESULT_OK;
...
ASN_Result Icb_OpPSIMNetworkConfiguration_Response_Encode( Icb_OpPSIMNetworkConfiguration_Response ThisPtr, ASN_Stream stream)
{
  ASN_Result result = ASN_RESULT_OK;
...
{
  Icb_OpPSIMConnectionStatus_Response value = ( Icb_OpPSIMConnectionStatus_Response ) ASN_Malloc( session, sizeof( struct Icb_OpPSIMConnectionStatus_Response_t ) );
...
ASN_Result Icb_OpPSIMConnectionStatus_Response_Decode( Icb_OpPSIMConnectionStatus_Response ThisPtr, ASN_Session session, ASN_Stream stream )
{
  ASN_Result result = ASN_RESULT_OK;
...
{
  Icb_OpPSIMConnectionStatus_Notification value = ( Icb_OpPSIMConnectionStatus_Notification ) ASN_Malloc( session, sizeof( struct Icb_OpPSIMConnectionStatus_Notification_t ) );
...
ASN_Result Icb_OpPSIMConnectionStatus_Notification_Decode( Icb_OpPSIMConnectionStatus_Notification ThisPtr, ASN_Session session, ASN_Stream stream )
{
  ASN_Result result = ASN_RESULT_OK;
  ASN_DECODE_CHECK( Icb_PSIMConnectionStatus_Decode( &ThisPtr->status, session, stream ) );
  ASN_DECODE_CHECK( Icb_WirelessTechnology_Decode( &ThisPtr->technology, session, stream ) );
...
ASN_Result Icb_OpPSIMConnectionStatus_Notification_Encode( Icb_OpPSIMConnectionStatus_Notification ThisPtr, ASN_Stream stream)
{
  ASN_Result result = ASN_RESULT_OK;
  ASN_ENCODE_CHECK( Icb_PSIMConnectionStatus_Encode( ThisPtr->status, stream) );
  ASN_ENCODE_CHECK( Icb_WirelessTechnology_Encode( ThisPtr->technology, stream) );
...
{
  Icb_OpInternetGateway_SetRequest value = ( Icb_OpInternetGateway_SetRequest ) ASN_Malloc( session, sizeof( struct Icb_OpInternetGateway_SetRequest_t ) );
...
ASN_Result Icb_OpInternetGateway_SetRequest_Decode( Icb_OpInternetGateway_SetRequest ThisPtr, ASN_Session session, ASN_Stream stream )
{
  ASN_Result result = ASN_RESULT_OK;
...
{
  Icb_OpInternetGateway_Response value = ( Icb_OpInternetGateway_Response ) ASN_Malloc( session, sizeof( struct Icb_OpInternetGateway_Response_t ) );
...
ASN_Result Icb_OpInternetGateway_Response_Decode( Icb_OpInternetGateway_Response ThisPtr, ASN_Session session, ASN_Stream stream )
{
  ASN_Result result = ASN_RESULT_OK;
  ASN_DECODE_CHECK( Icb_Ecu_Decode( &ThisPtr->internetGateway, session, stream ) );
  return ASN_RESULT_OK;
...
{
  Icb_OpConnectWorkshopWlan_Notification value = ( Icb_OpConnectWorkshopWlan_Notification ) ASN_Malloc( session, sizeof( struct Icb_OpConnectWorkshopWlan_Notification_t ) );
...
ASN_Result Icb_OpConnectWorkshopWlan_Notification_Decode( Icb_OpConnectWorkshopWlan_Notification ThisPtr, ASN_Session session, ASN_Stream stream )
{
  ASN_Result result = ASN_RESULT_OK;
...
ASN_Result Icb_OpConnectWorkshopWlan_Notification_Encode( Icb_OpConnectWorkshopWlan_Notification ThisPtr, ASN_Stream stream)
{
  ASN_Result result = ASN_RESULT_OK;
...
{
  Icb_OpCurrentInternetSource_SetRequest value = ( Icb_OpCurrentInternetSource_SetRequest ) ASN_Malloc( session, sizeof( struct Icb_OpCurrentInternetSource_SetRequest_t ) );
...
ASN_Result Icb_OpCurrentInternetSource_SetRequest_Decode( Icb_OpCurrentInternetSource_SetRequest ThisPtr, ASN_Session session, ASN_Stream stream )
{
  ASN_Result result = ASN_RESULT_OK;
...
ASN_Result Icb_OpCurrentInternetSource_SetRequest_Encode( Icb_OpCurrentInternetSource_SetRequest ThisPtr, ASN_Stream stream)
{
  ASN_Result result = ASN_RESULT_OK;
...
{
  Icb_OpCurrentInternetSource_Response value = ( Icb_OpCurrentInternetSource_Response ) ASN_Malloc( session, sizeof( struct Icb_OpCurrentInternetSource_Response_t ) );
...
ASN_Result Icb_OpCurrentInternetSource_Response_Decode( Icb_OpCurrentInternetSource_Response ThisPtr, ASN_Session session, ASN_Stream stream )
{
  ASN_Result result = ASN_RESULT_OK;
  ASN_DECODE_CHECK( Icb_InternetSource_Decode( &ThisPtr->currentinternetsource, session, stream ) );
  return ASN_RESULT_OK;
...
{
  Icb_OpCurrentInternetSource_Notification value = ( Icb_OpCurrentInternetSource_Notification ) ASN_Malloc( session, sizeof( struct Icb_OpCurrentInternetSource_Notification_t ) );
...
ASN_Result Icb_OpCurrentInternetSource_Notification_Decode( Icb_OpCurrentInternetSource_Notification ThisPtr, ASN_Session session, ASN_Stream stream )
{
  ASN_Result result = ASN_RESULT_OK;
  ASN_DECODE_CHECK( Icb_InternetSource_Decode( &ThisPtr->currentinternetsource, session, stream ) );
  return ASN_RESULT_OK;
...
ASN_Result Icb_OpCurrentInternetSource_Notification_Encode( Icb_OpCurrentInternetSource_Notification ThisPtr, ASN_Stream stream)
{
  ASN_Result result = ASN_RESULT_OK;
  ASN_ENCODE_CHECK( Icb_InternetSource_Encode( ThisPtr->currentinternetsource, stream) );
  return ASN_RESULT_OK;
...
{
  Icb_OpWLANMode_SetRequest value = ( Icb_OpWLANMode_SetRequest ) ASN_Malloc( session, sizeof( struct Icb_OpWLANMode_SetRequest_t ) );
...
{
  Icb_OpWLANMode_Response value = ( Icb_OpWLANMode_Response ) ASN_Malloc( session, sizeof( struct Icb_OpWLANMode_Response_t ) );
...
{
  Icb_OpWLANMode_Notification value = ( Icb_OpWLANMode_Notification ) ASN_Malloc( session, sizeof( struct Icb_OpWLANMode_Notification_t ) );
...
ASN_Result Icb_OpWLANMode_Notification_Decode( Icb_OpWLANMode_Notification ThisPtr, ASN_Session session, ASN_Stream stream )
{
  BOOL hasExtensions;
  ASN_Result result = ASN_RESULT_OK;
...
{
  Icb_OpWLANFreqBandSelect_SetRequest value = ( Icb_OpWLANFreqBandSelect_SetRequest ) ASN_Malloc( session, sizeof( struct Icb_OpWLANFreqBandSelect_SetRequest_t ) );
...
ASN_Result Icb_OpWLANFreqBandSelect_SetRequest_Decode( Icb_OpWLANFreqBandSelect_SetRequest ThisPtr, ASN_Session session, ASN_Stream stream )
{
  BOOL hasExtensions;
  ASN_Result result = ASN_RESULT_OK;
...
{
  Icb_OpWLANFreqBandSelect_Response value = ( Icb_OpWLANFreqBandSelect_Response ) ASN_Malloc( session, sizeof( struct Icb_OpWLANFreqBandSelect_Response_t ) );
...
ASN_Result Icb_OpWLANFreqBandSelect_Response_Decode( Icb_OpWLANFreqBandSelect_Response ThisPtr, ASN_Session session, ASN_Stream stream )
{
  BOOL hasExtensions;
  ASN_Result result = ASN_RESULT_OK;
...
{
  Icb_OpWLANAPSSID_SetRequest value = ( Icb_OpWLANAPSSID_SetRequest ) ASN_Malloc( session, sizeof( struct Icb_OpWLANAPSSID_SetRequest_t ) );
...
ASN_Result Icb_OpWLANAPSSID_SetRequest_Decode( Icb_OpWLANAPSSID_SetRequest ThisPtr, ASN_Session session, ASN_Stream stream )
{
  BOOL hasExtensions;
  ASN_Result result = ASN_RESULT_OK;
...
{
  Icb_OpWLANAPSSID_Response value = ( Icb_OpWLANAPSSID_Response ) ASN_Malloc( session, sizeof( struct Icb_OpWLANAPSSID_Response_t ) );
...
{
  Icb_OpWLANAPPasswd_SetRequest value = ( Icb_OpWLANAPPasswd_SetRequest ) ASN_Malloc( session, sizeof( struct Icb_OpWLANAPPasswd_SetRequest_t ) );
...
ASN_Result Icb_OpWLANAPPasswd_SetRequest_Decode( Icb_OpWLANAPPasswd_SetRequest ThisPtr, ASN_Session session, ASN_Stream stream )
{
  BOOL hasExtensions;
  ASN_Result result = ASN_RESULT_OK;
...
{
  Icb_OpWLANAPPasswd_Response value = ( Icb_OpWLANAPPasswd_Response ) ASN_Malloc( session, sizeof( struct Icb_OpWLANAPPasswd_Response_t ) );
...
ASN_Result Icb_OpWLANAPPasswd_Response_Decode( Icb_OpWLANAPPasswd_Response ThisPtr, ASN_Session session, ASN_Stream stream )
{
  BOOL hasExtensions;
  ASN_Result result = ASN_RESULT_OK;
...
{
  Icb_OpWLANAPConnDev_Response value = ( Icb_OpWLANAPConnDev_Response ) ASN_Malloc( session, sizeof( struct Icb_OpWLANAPConnDev_Response_t ) );
...
ASN_Result Icb_OpWLANAPConnDev_Response_Decode( Icb_OpWLANAPConnDev_Response ThisPtr, ASN_Session session, ASN_Stream stream )
{
  BOOL hasExtensions;
  ASN_Result result = ASN_RESULT_OK;
...
{
  Icb_OpWLANAPConnDev_Notification value = ( Icb_OpWLANAPConnDev_Notification ) ASN_Malloc( session, sizeof( struct Icb_OpWLANAPConnDev_Notification_t ) );
...
ASN_Result Icb_OpWLANAPConnDev_Notification_Decode( Icb_OpWLANAPConnDev_Notification ThisPtr, ASN_Session session, ASN_Stream stream )
{
  BOOL hasExtensions;
  ASN_Result result = ASN_RESULT_OK;
...
{
  Icb_OpWLANSTAConnect_SetRequest value = ( Icb_OpWLANSTAConnect_SetRequest ) ASN_Malloc( session, sizeof( struct Icb_OpWLANSTAConnect_SetRequest_t ) );
...
ASN_Result Icb_OpWLANSTAConnect_SetRequest_Decode( Icb_OpWLANSTAConnect_SetRequest ThisPtr, ASN_Session session, ASN_Stream stream )
{
  BOOL hasExtensions;
  ASN_Result result = ASN_RESULT_OK;
...
{
  Icb_OpWLANSTAConnect_Response value = ( Icb_OpWLANSTAConnect_Response ) ASN_Malloc( session, sizeof( struct Icb_OpWLANSTAConnect_Response_t ) );
...
ASN_Result Icb_OpWLANSTAConnect_Response_Decode( Icb_OpWLANSTAConnect_Response ThisPtr, ASN_Session session, ASN_Stream stream )
{
  BOOL hasExtensions;
  ASN_Result result = ASN_RESULT_OK;
...
{
  Icb_OpWLANAPStatusSettings_Response value = ( Icb_OpWLANAPStatusSettings_Response ) ASN_Malloc( session, sizeof( struct Icb_OpWLANAPStatusSettings_Response_t ) );
...
ASN_Result Icb_OpWLANAPStatusSettings_Response_Decode( Icb_OpWLANAPStatusSettings_Response ThisPtr, ASN_Session session, ASN_Stream stream )
{
  BOOL hasExtensions;
  ASN_Result result = ASN_RESULT_OK;
...
{
  Icb_OpWLANSTAStatus_Response value = ( Icb_OpWLANSTAStatus_Response ) ASN_Malloc( session, sizeof( struct Icb_OpWLANSTAStatus_Response_t ) );
...
ASN_Result Icb_OpWLANSTAStatus_Response_Decode( Icb_OpWLANSTAStatus_Response ThisPtr, ASN_Session session, ASN_Stream stream )
{
  BOOL hasExtensions;
  ASN_Result result = ASN_RESULT_OK;
  ...
  ASN_DECODE_CHECK( Icb_ArrayOf_AvailableNetworkInformation_Decode( ThisPtr->availableNetworkInfoList, session, stream, 0, 100 ) );
  return ASN_RESULT_OK;
}
...
{
  Icb_OpWLANSTAStatus_Notification value = ( Icb_OpWLANSTAStatus_Notification ) ASN_Malloc( session, sizeof( struct Icb_OpWLANSTAStatus_Notification_t ) );
...
ASN_Result Icb_OpWLANSTAStatus_Notification_Decode( Icb_OpWLANSTAStatus_Notification ThisPtr, ASN_Session session, ASN_Stream stream )
{
  BOOL hasExtensions;
  ASN_Result result = ASN_RESULT_OK;
...
{
  Icb_AvailableNetworkInformation value = ( Icb_AvailableNetworkInformation ) ASN_Malloc( session, sizeof( struct Icb_AvailableNetworkInformation_t ) );
...
ASN_Result Icb_AvailableNetworkInformation_Decode( Icb_AvailableNetworkInformation ThisPtr, ASN_Session session, ASN_Stream stream )
{
  BOOL hasExtensions;
  ASN_Result result = ASN_RESULT_OK;
...
{
  Icb_OpWLANSTARememberedNetwks_Response value = ( Icb_OpWLANSTARememberedNetwks_Response ) ASN_Malloc( session, sizeof( struct Icb_OpWLANSTARememberedNetwks_Response_t ) );
...
ASN_Result Icb_OpWLANSTARememberedNetwks_Response_Decode( Icb_OpWLANSTARememberedNetwks_Response ThisPtr, ASN_Session session, ASN_Stream stream )
{
  BOOL hasExtensions;
  ASN_Result result = ASN_RESULT_OK;
...
ASN_Result Icb_OpWLANSTARememberedNetwks_Response_Encode( Icb_OpWLANSTARememberedNetwks_Response ThisPtr, ASN_Stream stream)
{
  ASN_Result result = ASN_RESULT_OK;
...
{
  Icb_OpPSIMSecurity_SetRequest value = ( Icb_OpPSIMSecurity_SetRequest ) ASN_Malloc( session, sizeof( struct Icb_OpPSIMSecurity_SetRequest_t ) );
...
ASN_Result Icb_OpPSIMSecurity_SetRequest_Decode( Icb_OpPSIMSecurity_SetRequest ThisPtr, ASN_Session session, ASN_Stream stream )
{
  BOOL hasExtensions;
  ASN_Result result = ASN_RESULT_OK;
...
{
  Icb_OpPSIMEnterCode_SetRequest value = ( Icb_OpPSIMEnterCode_SetRequest ) ASN_Malloc( session, sizeof( struct Icb_OpPSIMEnterCode_SetRequest_t ) );
...
ASN_Result Icb_OpPSIMEnterCode_SetRequest_Decode( Icb_OpPSIMEnterCode_SetRequest ThisPtr, ASN_Session session, ASN_Stream stream )
{
  BOOL hasExtensions;
  ASN_Result result = ASN_RESULT_OK;
...
{
  Icb_OpPSIMRegisterState_Response value = ( Icb_OpPSIMRegisterState_Response ) ASN_Malloc( session, sizeof( struct Icb_OpPSIMRegisterState_Response_t ) );
...
ASN_Result Icb_OpPSIMRegisterState_Response_Decode( Icb_OpPSIMRegisterState_Response ThisPtr, ASN_Session session, ASN_Stream stream )
{
  BOOL hasExtensions;
  ASN_Result result = ASN_RESULT_OK;
...
{
  Icb_OpPSIMNetworkOperators_Response value = ( Icb_OpPSIMNetworkOperators_Response ) ASN_Malloc( session, sizeof( struct Icb_OpPSIMNetworkOperators_Response_t ) );
...
ASN_Result Icb_OpPSIMNetworkOperators_Response_Decode( Icb_OpPSIMNetworkOperators_Response ThisPtr, ASN_Session session, ASN_Stream stream )
{
  BOOL hasExtensions;
  ASN_Result result = ASN_RESULT_OK;
...
{
  Icb_OpPSIMNetworkOperatorCommand_SetRequest value = ( Icb_OpPSIMNetworkOperatorCommand_SetRequest ) ASN_Malloc( session, sizeof( struct Icb_OpPSIMNetworkOperatorCommand_SetRequest_t ) );
...
ASN_Result Icb_OpPSIMNetworkOperatorCommand_SetRequest_Decode( Icb_OpPSIMNetworkOperatorCommand_SetRequest ThisPtr, ASN_Session session, ASN_Stream stream )
{
  BOOL hasExtensions;
  ASN_Result result = ASN_RESULT_OK;
...
ASN_Result Icb_OpPSIMNetworkOperatorCommand_SetRequest_Encode( Icb_OpPSIMNetworkOperatorCommand_SetRequest ThisPtr, ASN_Stream stream)
{
  ASN_Result result = ASN_RESULT_OK;
...
{
  Icb_OpPSIMNetworkOperatorCommand_Response value = ( Icb_OpPSIMNetworkOperatorCommand_Response ) ASN_Malloc( session, sizeof( struct Icb_OpPSIMNetworkOperatorCommand_Response_t ) );
...
ASN_Result Icb_OpPSIMNetworkOperatorCommand_Response_Decode( Icb_OpPSIMNetworkOperatorCommand_Response ThisPtr, ASN_Session session, ASN_Stream stream )
{
  BOOL hasExtensions;
  ASN_Result result = ASN_RESULT_OK;
...
ASN_Result Icb_OpPSIMNetworkOperatorCommand_Response_Encode( Icb_OpPSIMNetworkOperatorCommand_Response ThisPtr, ASN_Stream stream)
{
  ASN_Result result = ASN_RESULT_OK;
...
{
  Icb_OpPSIMNetworkOperatorCommand_Notification value = ( Icb_OpPSIMNetworkOperatorCommand_Notification ) ASN_Malloc( session, sizeof( struct Icb_OpPSIMNetworkOperatorCommand_Notification_t ) );
...
ASN_Result Icb_OpPSIMNetworkOperatorCommand_Notification_Decode( Icb_OpPSIMNetworkOperatorCommand_Notification ThisPtr, ASN_Session session, ASN_Stream stream )
{
  ASN_Result result = ASN_RESULT_OK;
  ASN_DECODE_CHECK( Icb_OperatorSelection_Decode( ThisPtr->status, session, stream ) );
  ASN_DECODE_CHECK( Icb_GenericOkStatus_Decode( &ThisPtr->operatorSelectionResult, session, stream ) );
...
ASN_Result Icb_OpPSIMNetworkOperatorCommand_Notification_Encode( Icb_OpPSIMNetworkOperatorCommand_Notification ThisPtr, ASN_Stream stream)
{
  ASN_Result result = ASN_RESULT_OK;
  ASN_ENCODE_CHECK( Icb_OperatorSelection_Encode( ThisPtr->status, stream) );
  ASN_ENCODE_CHECK( Icb_GenericOkStatus_Encode( ThisPtr->operatorSelectionResult, stream) );
...
{
  Icb_OpPSIMState_Response value = ( Icb_OpPSIMState_Response ) ASN_Malloc( session, sizeof( struct Icb_OpPSIMState_Response_t ) );
...
{
  Icb_OpPSIMPhoneOperationMode_Response value = ( Icb_OpPSIMPhoneOperationMode_Response ) ASN_Malloc( session, sizeof( struct Icb_OpPSIMPhoneOperationMode_Response_t ) );
...
ASN_Result Icb_OpPSIMPhoneOperationMode_Response_Decode( Icb_OpPSIMPhoneOperationMode_Response ThisPtr, ASN_Session session, ASN_Stream stream )
{
  BOOL hasExtensions;
  ASN_Result result = ASN_RESULT_OK;
...
ASN_Result Icb_OpPSIMPhoneOperationMode_Response_Encode( Icb_OpPSIMPhoneOperationMode_Response ThisPtr, ASN_Stream stream)
{
  ASN_Result result = ASN_RESULT_OK;
...
{
  Icb_OpPSIMUssd_SetRequest value = ( Icb_OpPSIMUssd_SetRequest ) ASN_Malloc( session, sizeof( struct Icb_OpPSIMUssd_SetRequest_t ) );
...
{
  Icb_OpPSIMUssd_Response value = ( Icb_OpPSIMUssd_Response ) ASN_Malloc( session, sizeof( struct Icb_OpPSIMUssd_Response_t ) );
...
{
  Icb_OpCallHandling_SetRequest value = ( Icb_OpCallHandling_SetRequest ) ASN_Malloc( session, sizeof( struct Icb_OpCallHandling_SetRequest_t ) );
...
ASN_Result Icb_OpCallHandling_SetRequest_Decode( Icb_OpCallHandling_SetRequest ThisPtr, ASN_Session session, ASN_Stream stream )
{
  BOOL hasExtensions;
  ASN_Result result = ASN_RESULT_OK;
...
{
  Icb_OpTEMIdentification_Response value = ( Icb_OpTEMIdentification_Response ) ASN_Malloc( session, sizeof( struct Icb_OpTEMIdentification_Response_t ) );
...
ASN_Result Icb_OpTEMIdentification_Response_Decode( Icb_OpTEMIdentification_Response ThisPtr, ASN_Session session, ASN_Stream stream )
{
  BOOL hasExtensions;
  ASN_Result result = ASN_RESULT_OK;
...
{
  Icb_OpTEMRadioMode_SetRequest value = ( Icb_OpTEMRadioMode_SetRequest ) ASN_Malloc( session, sizeof( struct Icb_OpTEMRadioMode_SetRequest_t ) );
...
ASN_Result Icb_OpTEMRadioMode_SetRequest_Decode( Icb_OpTEMRadioMode_SetRequest ThisPtr, ASN_Session session, ASN_Stream stream )
{
  BOOL hasExtensions;
  ASN_Result result = ASN_RESULT_OK;
...
{
  Icb_OpTEMRadioMode_Response value = ( Icb_OpTEMRadioMode_Response ) ASN_Malloc( session, sizeof( struct Icb_OpTEMRadioMode_Response_t ) );
...
ASN_Result Icb_OpTEMRadioMode_Response_Decode( Icb_OpTEMRadioMode_Response ThisPtr, ASN_Session session, ASN_Stream stream )
{
  BOOL hasExtensions;
  ASN_Result result = ASN_RESULT_OK;
...
{
  Icb_OpTunerFrequencies_Response value = ( Icb_OpTunerFrequencies_Response ) ASN_Malloc( session, sizeof( struct Icb_OpTunerFrequencies_Response_t ) );
...
ASN_Result Icb_OpTunerFrequencies_Response_Decode( Icb_OpTunerFrequencies_Response ThisPtr, ASN_Session session, ASN_Stream stream )
{
  BOOL hasExtensions;
  ASN_Result result = ASN_RESULT_OK;
...
{
  Icb_OpDeadReckonedPosition_Response value = ( Icb_OpDeadReckonedPosition_Response ) ASN_Malloc( session, sizeof( struct Icb_OpDeadReckonedPosition_Response_t ) );
...
ASN_Result Icb_OpDeadReckonedPosition_Response_Decode( Icb_OpDeadReckonedPosition_Response ThisPtr, ASN_Session session, ASN_Stream stream )
{
  BOOL hasExtensions;
  ASN_Result result = ASN_RESULT_OK;
...
{
  Icb_GeographicalPosition value = ( Icb_GeographicalPosition ) ASN_Malloc( session, sizeof( struct Icb_GeographicalPosition_t ) );
...
{
  Icb_OpRemoteDiagnosticInfo_Notification value = ( Icb_OpRemoteDiagnosticInfo_Notification ) ASN_Malloc( session, sizeof( struct Icb_OpRemoteDiagnosticInfo_Notification_t ) );
...
ASN_Result Icb_OpRemoteDiagnosticInfo_Notification_Decode( Icb_OpRemoteDiagnosticInfo_Notification ThisPtr, ASN_Session session, ASN_Stream stream )
{
  BOOL hasExtensions;
  ASN_Result result = ASN_RESULT_OK;
...
ASN_Result Icb_OpRemoteDiagnosticInfo_Notification_Encode( Icb_OpRemoteDiagnosticInfo_Notification ThisPtr, ASN_Stream stream)
{
  ASN_Result result = ASN_RESULT_OK;
...
{
  Icb_OpCurrentDoIPState_Notification value = ( Icb_OpCurrentDoIPState_Notification ) ASN_Malloc( session, sizeof( struct Icb_OpCurrentDoIPState_Notification_t ) );
...
ASN_Result Icb_OpCurrentDoIPState_Notification_Decode( Icb_OpCurrentDoIPState_Notification ThisPtr, ASN_Session session, ASN_Stream stream )
{
  BOOL hasExtensions;
  ASN_Result result = ASN_RESULT_OK;
...
{
  Icb_OpCurrentDoIPConnection_Notification value = ( Icb_OpCurrentDoIPConnection_Notification ) ASN_Malloc( session, sizeof( struct Icb_OpCurrentDoIPConnection_Notification_t ) );
...
ASN_Result Icb_OpCurrentDoIPConnection_Notification_Decode( Icb_OpCurrentDoIPConnection_Notification ThisPtr, ASN_Session session, ASN_Stream stream )
{
  BOOL hasExtensions;
  ASN_Result result = ASN_RESULT_OK;
...
ASN_Result Icb_OpCurrentDoIPConnection_Notification_Encode( Icb_OpCurrentDoIPConnection_Notification ThisPtr, ASN_Stream stream)
{
  ASN_Result result = ASN_RESULT_OK;
...
{
  Icb_OpRequestUserAuthentication_Response value = ( Icb_OpRequestUserAuthentication_Response ) ASN_Malloc( session, sizeof( struct Icb_OpRequestUserAuthentication_Response_t ) );
...
ASN_Result Icb_OpRequestUserAuthentication_Response_Decode( Icb_OpRequestUserAuthentication_Response ThisPtr, ASN_Session session, ASN_Stream stream )
{
  BOOL hasExtensions;
  ASN_Result result = ASN_RESULT_OK;
...
ASN_Result Icb_OpRequestUserAuthentication_Response_Encode( Icb_OpRequestUserAuthentication_Response ThisPtr, ASN_Stream stream)
{
  ASN_Result result = ASN_RESULT_OK;
...
{
  Icb_OpUpdateDaCMode_Notification value = ( Icb_OpUpdateDaCMode_Notification ) ASN_Malloc( session, sizeof( struct Icb_OpUpdateDaCMode_Notification_t ) );
...
ASN_Result Icb_OpUpdateDaCMode_Notification_Decode( Icb_OpUpdateDaCMode_Notification ThisPtr, ASN_Session session, ASN_Stream stream )
{
  BOOL hasExtensions;
  ASN_Result result = ASN_RESULT_OK;
...
{
  Icb_OpApprovalStatus_Response value = ( Icb_OpApprovalStatus_Response ) ASN_Malloc( session, sizeof( struct Icb_OpApprovalStatus_Response_t ) );
...
ASN_Result Icb_OpApprovalStatus_Response_Decode( Icb_OpApprovalStatus_Response ThisPtr, ASN_Session session, ASN_Stream stream )
{
  BOOL hasExtensions;
  ASN_Result result = ASN_RESULT_OK;
...
{
  Icb_OpApprovalStatus_Notification value = ( Icb_OpApprovalStatus_Notification ) ASN_Malloc( session, sizeof( struct Icb_OpApprovalStatus_Notification_t ) );
...
ASN_Result Icb_OpApprovalStatus_Notification_Decode( Icb_OpApprovalStatus_Notification ThisPtr, ASN_Session session, ASN_Stream stream )
{
  BOOL hasExtensions;
  ASN_Result result = ASN_RESULT_OK;
...
{
  Icb_OpDownloadStatus_Response value = ( Icb_OpDownloadStatus_Response ) ASN_Malloc( session, sizeof( struct Icb_OpDownloadStatus_Response_t ) );
...
ASN_Result Icb_OpDownloadStatus_Response_Decode( Icb_OpDownloadStatus_Response ThisPtr, ASN_Session session, ASN_Stream stream )
{
  BOOL hasExtensions;
  ASN_Result result = ASN_RESULT_OK;
...
{
  Icb_OpDownloadSoftware_SetRequest value = ( Icb_OpDownloadSoftware_SetRequest ) ASN_Malloc( session, sizeof( struct Icb_OpDownloadSoftware_SetRequest_t ) );
...
ASN_Result Icb_OpDownloadSoftware_SetRequest_Decode( Icb_OpDownloadSoftware_SetRequest ThisPtr, ASN_Session session, ASN_Stream stream )
{
  BOOL hasExtensions;
  ASN_Result result = ASN_RESULT_OK;
...
{
  Icb_OpDeletedSoftware_SetRequest value = ( Icb_OpDeletedSoftware_SetRequest ) ASN_Malloc( session, sizeof( struct Icb_OpDeletedSoftware_SetRequest_t ) );
...
ASN_Result Icb_OpDeletedSoftware_SetRequest_Decode( Icb_OpDeletedSoftware_SetRequest ThisPtr, ASN_Session session, ASN_Stream stream )
{
  BOOL hasExtensions;
  ASN_Result result = ASN_RESULT_OK;
...
{
  Icb_OpDeviceInstall_SetRequest value = ( Icb_OpDeviceInstall_SetRequest ) ASN_Malloc( session, sizeof( struct Icb_OpDeviceInstall_SetRequest_t ) );
...
ASN_Result Icb_OpDeviceInstall_SetRequest_Decode( Icb_OpDeviceInstall_SetRequest ThisPtr, ASN_Session session, ASN_Stream stream )
{
  BOOL hasExtensions;
  ASN_Result result = ASN_RESULT_OK;
...
{
  Icb_OpDeviceInstall_Response value = ( Icb_OpDeviceInstall_Response ) ASN_Malloc( session, sizeof( struct Icb_OpDeviceInstall_Response_t ) );
...
ASN_Result Icb_OpDeviceInstall_Response_Decode( Icb_OpDeviceInstall_Response ThisPtr, ASN_Session session, ASN_Stream stream )
{
  BOOL hasExtensions;
  ASN_Result result = ASN_RESULT_OK;
...
{
  Icb_OpEcallSettings_SetRequest value = ( Icb_OpEcallSettings_SetRequest ) ASN_Malloc( session, sizeof( struct Icb_OpEcallSettings_SetRequest_t ) );
...
ASN_Result Icb_OpEcallSettings_SetRequest_Decode( Icb_OpEcallSettings_SetRequest ThisPtr, ASN_Session session, ASN_Stream stream )
{
  BOOL hasExtensions;
  ASN_Result result = ASN_RESULT_OK;
...
{
  Icb_OpEcallSettings_Response value = ( Icb_OpEcallSettings_Response ) ASN_Malloc( session, sizeof( struct Icb_OpEcallSettings_Response_t ) );
...
ASN_Result Icb_OpEcallSettings_Response_Decode( Icb_OpEcallSettings_Response ThisPtr, ASN_Session session, ASN_Stream stream )
{
  BOOL hasExtensions;
  ASN_Result result = ASN_RESULT_OK;
...
{
  Icb_OpWLANChannelFreqInfo_Notification value = ( Icb_OpWLANChannelFreqInfo_Notification ) ASN_Malloc( session, sizeof( struct Icb_OpWLANChannelFreqInfo_Notification_t ) );
...
ASN_Result Icb_OpWLANChannelFreqInfo_Notification_Decode( Icb_OpWLANChannelFreqInfo_Notification ThisPtr, ASN_Session session, ASN_Stream stream )
{
  BOOL hasExtensions;
  ASN_Result result = ASN_RESULT_OK;
...
ASN_Result Icb_OpWLANChannelFreqInfo_Notification_Encode( Icb_OpWLANChannelFreqInfo_Notification ThisPtr, ASN_Stream stream)
{
  ASN_Result result = ASN_RESULT_OK;
...
{
  Icb_OpGNSSPositionDataAccuracy_Response value = ( Icb_OpGNSSPositionDataAccuracy_Response ) ASN_Malloc( session, sizeof( struct Icb_OpGNSSPositionDataAccuracy_Response_t ) );
...
ASN_Result Icb_OpGNSSPositionDataAccuracy_Response_Decode( Icb_OpGNSSPositionDataAccuracy_Response ThisPtr, ASN_Session session, ASN_Stream stream )
{
  BOOL hasExtensions;
  ASN_Result result = ASN_RESULT_OK;
...
ASN_Result Icb_OpGNSSPositionDataAccuracy_Response_Encode( Icb_OpGNSSPositionDataAccuracy_Response ThisPtr, ASN_Stream stream)
{
  ASN_Result result = ASN_RESULT_OK;
...
{
  Icb_OpGNSSPositionData_Response value = ( Icb_OpGNSSPositionData_Response ) ASN_Malloc( session, sizeof( struct Icb_OpGNSSPositionData_Response_t ) );
...
ASN_Result Icb_OpGNSSPositionData_Response_Decode( Icb_OpGNSSPositionData_Response ThisPtr, ASN_Session session, ASN_Stream stream )
{
  BOOL hasExtensions;
  ASN_Result result = ASN_RESULT_OK;
