...
namespace logging {
    ...
    {
        if ((LogLevel::None == g_log_level) ||
            (severity_ > g_log_level))
        {
            return *this;
        }
        va_list argList;
    ...
    void LogClass::logE()
    {
        switch (g_log_detail_level) {
            ...
            case LogDetailLevel::LogVerbose:
                ALOGE(VERBOSE_LOG(severityToStr(severity_).c_str(), file_.c_str(), func_.c_str(), line_, logstring_.c_str()));
                break;
        }
    }
    ...
    void LogClass::logW()
    {
        switch (g_log_detail_level) {
            ...
            case LogDetailLevel::LogCompactSpaced:
                ...
                break;
            case LogDetailLevel::LogVerbose:
                ALOGW(VERBOSE_LOG(severityToStr(severity_).c_str(), file_.c_str(), func_.c_str(), line_, logstring_.c_str()));
                break;
        }
    }
    ...
    void LogClass::logD()
    {
        switch (g_log_detail_level) {
            ...
            case LogDetailLevel::LogCompactSpaced:
                ...
                break;
            case LogDetailLevel::LogVerbose:
                ALOGD(VERBOSE_LOG(severityToStr(severity_).c_str(), file_.c_str(), func_.c_str(), line_, logstring_.c_str()));
                break;
        }
    }
    ...
    void LogClass::logI()
    {
        switch (g_log_detail_level) {
            ...
            case LogDetailLevel::LogCompactSpaced:
                ...
                break;
            case LogDetailLevel::LogVerbose:
                ALOGI(VERBOSE_LOG(severityToStr(severity_).c_str(), file_.c_str(), func_.c_str(), line_, logstring_.c_str()));
                break;
        }
    }
