...
private:
    ...
    SettingsProxy<double, SettingsFramework::UserScope::USER, SettingsFramework::UserScope::NOT_USER_RELATED>&                    sTemperatureDriverProxy_;
    SettingsProxy<autosar::HmiCmptmtTSpSpcl, SettingsFramework::UserScope::USER, SettingsFramework::UserScope::NOT_USER_RELATED>& sTemperatureDriverHiLoNProxy_;
    SettingsProxy<double, SettingsFramework::UserScope::NOT_USER_RELATED, SettingsFramework::UserScope::NOT_USER_RELATED>&                    sTemperaturePassengerProxy_;
    SettingsProxy<autosar::HmiCmptmtTSpSpcl, SettingsFramework::UserScope::NOT_USER_RELATED, SettingsFramework::UserScope::NOT_USER_RELATED>& sTemperaturePassengerHiLoNProxy_;
