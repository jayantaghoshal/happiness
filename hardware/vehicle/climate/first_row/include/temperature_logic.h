...
class TemperatureLogic : public common::daemon::ITemperatureLogic {
  public:
    TemperatureLogic(bool isValidCarConfig, common::daemon::TemperatureConverter& tempConverter,
                     NotifiableProperty<double>& convertedTemp, NotifiableProperty<double>& storedTemp,
                     NotifiableProperty<autosar::HmiCmptmtTSpSpcl>& storedTempHiLoN, NotifiableProperty<double>& temp,
