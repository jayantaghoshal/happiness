...
{
public:
    explicit AirConditionerLogic(SettingsProxy<FirstRowGen::AirConditionerState::Literal, UserScope::USER, UserScope::NOT_USER_RELATED>&         sAirConditioner,
...
private:
    SettingsProxy<FirstRowGen::AirConditionerState::Literal, UserScope::USER, UserScope::NOT_USER_RELATED>& settingAirConditioner;
