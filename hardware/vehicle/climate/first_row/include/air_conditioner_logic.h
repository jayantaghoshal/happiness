...
#ifndef AIRCONDITIONERLOGIC_H
#define AIRCONDITIONERLOGIC_H
...
class AirConditionerLogic {
  public:
    explicit AirConditionerLogic(SettingsProxy<FirstRowGen::AirConditionerState::Literal, UserScope::USER,
                                               UserScope::NOT_USER_RELATED>& sAirConditioner,
  ...
  private:
    ...
    void setState(bool isActive, FirstRowGen::FanLevelFrontValue fanLevel,
                  FirstRowGen::AirConditionerState airConditioner, bool isInError = false);
    void sendAcSignal();
