...
public:
    ...
    FanLevelFrontLogic(SettingsProxyInterface<FirstRowGen::FanLevelFrontValue::Literal>& autoFanLevelSetting,
                       SettingsProxy<FirstRowGen::FanLevelFrontValue::Literal, SettingsFramework::UserScope::USER, SettingsFramework::UserScope::NOT_USER_RELATED>&              fanLevelFrontSetting,
...
private:
    ...
    SettingsProxy<FirstRowGen::FanLevelFrontValue::Literal, SettingsFramework::UserScope::USER, SettingsFramework::UserScope::NOT_USER_RELATED>&              fanLevelFrontSetting_;
