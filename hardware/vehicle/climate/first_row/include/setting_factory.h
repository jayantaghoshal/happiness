...
class SettingFactory {
  public:
    SettingFactory(const android::sp<SettingsFramework::SettingsManager>& sm);
  ...
  public:
    ...
    SettingsFramework::Setting<FirstRowGen::AirConditionerState::Literal, UserScope::NOT_USER_RELATED>
            AirConditionerDyno_;
    SettingsProxy<FirstRowGen::AirConditionerState::Literal, UserScope::USER, UserScope::NOT_USER_RELATED>
            AirConditionerProxy_;

    SettingsFramework::Setting<FirstRowGen::AirDistributionAngle::Literal, UserScope::USER> AirDistribution_;
    SettingsFramework::Setting<FirstRowGen::AirDistributionAngle::Literal, UserScope::NOT_USER_RELATED>
            AirDistributionDyno_;
    SettingsProxy<FirstRowGen::AirDistributionAngle::Literal, UserScope::USER, UserScope::NOT_USER_RELATED>
            AirDistributionProxy_;
    ...
    SettingsFramework::Setting<FirstRowGen::FanLevelFrontValue::Literal, UserScope::NOT_USER_RELATED>
            LastAutoFanLevelDyno_;
    SettingsProxy<FirstRowGen::FanLevelFrontValue::Literal, UserScope::USER, UserScope::NOT_USER_RELATED>
            lastAutoFanLevelFrontProxy_;
    ...
    SettingsProxy<autosar::HmiCmptmtTSpSpcl, UserScope::NOT_USER_RELATED, UserScope::NOT_USER_RELATED>
            TemperaturePassengerHiLoNProxy_;
    ...
    SettingsProxy<FirstRowGen::HeatLevel::Literal, UserScope::USER, UserScope::NOT_USER_RELATED>
            seatHeatLevelDriverProxy_;

    SettingsFramework::Setting<FirstRowGen::HeatLevel::Literal, UserScope::NOT_USER_RELATED> seatHeatLevelPassenger_;
    SettingsFramework::Setting<FirstRowGen::HeatLevel::Literal, UserScope::NOT_USER_RELATED>
            seatHeatLevelPassengerDyno_;
    SettingsProxy<FirstRowGen::HeatLevel::Literal, UserScope::NOT_USER_RELATED, UserScope::NOT_USER_RELATED>
            seatHeatLevelPassengerProxy_;
    ...
    SettingsProxy<FirstRowGen::VentLevel::Literal, UserScope::USER, UserScope::NOT_USER_RELATED>
            seatVentLevelDriverProxy_;

    SettingsFramework::Setting<FirstRowGen::VentLevel::Literal, UserScope::NOT_USER_RELATED> seatVentLevelPassenger_;
    SettingsFramework::Setting<FirstRowGen::VentLevel::Literal, UserScope::NOT_USER_RELATED>
            seatVentLevelPassengerDyno_;
    SettingsProxy<FirstRowGen::VentLevel::Literal, UserScope::NOT_USER_RELATED, UserScope::NOT_USER_RELATED>
            seatVentLevelPassengerProxy_;
