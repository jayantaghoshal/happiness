...
public:
    explicit AirDistributionLogic(NotifiableProperty<AirDistributionAngle>&                  AirDistribution,
                                  SettingsProxy<FirstRowGen::AirDistributionAngle::Literal, SettingsFramework::UserScope::USER, SettingsFramework::UserScope::NOT_USER_RELATED>& settingsAirDistrubution,
...
private:
    ...
    SettingsProxy<FirstRowGen::AirDistributionAngle::Literal, SettingsFramework::UserScope::USER, SettingsFramework::UserScope::NOT_USER_RELATED>& sAirDistribution;
