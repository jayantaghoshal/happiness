...
FirstRowFactory::FirstRowFactory(const vcc::LocalConfigReaderInterface* lcfg,
    ...
    : sf_{settingsManager},
      ...
      fanLevelFrontLogic_{lcfg,           sf_.lastAutoFanLevelFrontProxy_, sf_.lastFanLevelFrontProxy_,
                          fanLevelFront_, commonFactory.maxDefroster_,     autoClimate_,
                          climateReset_,  fanLevelFrontnDispatcher_},
      ...
      electricDefrosterWindscreenLogic_{lcfg, electricDefrosterWindscreen_, userSelections_.autoFrontDefroster_,
      ...
      electricDefrosterRearLogic_{lcfg, electricDefrosterRear_, userSelections_.autoRearDefroster_,
