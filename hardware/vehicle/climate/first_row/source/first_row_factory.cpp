...
FirstRowFactory::FirstRowFactory(android::sp<SettingsFramework::SettingsManager> settingsManager,
    ...
    , autoClimateLogic_{ autoClimate_,
                         autoClimateEvent_,
                         airDistribution_,
                         fanLevelFront_,
                         commonFactory.maxDefroster_ }
    ...
    , electricDefrosterWindscreenLogic_{ electricDefrosterWindscreen_,
    ...
    , electricDefrosterRearLogic_{ electricDefrosterRear_,
    ...
    , steeringWheelHeatLogic_{ steeringWheelHeat_,
...
ReadOnlyNotifiableProperty<FirstRowGen::ElectricDefrosterRearState>& FirstRowFactory::getElectricDefrosterRearProperty()
{
