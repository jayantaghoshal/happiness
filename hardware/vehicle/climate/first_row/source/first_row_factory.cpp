...
FirstRowFactory::FirstRowFactory(const android::sp<SettingsFramework::SettingsManager>& settingsManager,
                                 tarmac::timeprovider::TimerManagerInterface& timeProvider,
                                 signal_proxy::Proxies& proxies, UserSelectionFactory& userSelections,
    ...
    : sf_{settingsManager},
      ...
      fanLevelFrontLogic_{sf_.lastAutoFanLevelFrontProxy_,
      ...
      airDistributionLogic_{airDistribution_, sf_.AirDistributionProxy_,  climateReset_, fanLevelFront_,
                            autoClimate_,     commonFactory.maxDefroster_},
      ...
      manualRecircLogic_{userSelections_.manualRecircTimer_,
                         ...
                         autoClimateEvent_,
                         commonFactory.maxDefroster_},
      airConditionerLogic_{sf_.AirConditionerProxy_,    airConditioner_,   fanLevelFront_,
                           commonFactory.maxDefroster_, autoClimateEvent_, climateReset_},
      electricDefrosterWindscreenLogic_{electricDefrosterWindscreen_, userSelections_.autoFrontDefroster_,
                                        electricDefrosterWindscreenDispatcher_, proxies.hmiDefrstElecReq_},
      electricDefrosterRearPopupLogic_{electricDefrosterRear_, electricDefrosterRearPopup_},
      electricDefrosterRearLogic_{electricDefrosterRear_, userSelections_.autoRearDefroster_,
                                  electricDefrosterRearDispatcher_, proxies.hmiDefrstElecReq_},
      seatHeatDriverLogic_{SeatHeatLogic::UserLocation::DRIVER,
                           ...
                           timeProvider_},
      seatHeatPassengerLogic_{SeatHeatLogic::UserLocation::PASSENGER,
                              proxies.seatClimateStatus_,
                              seatHeatPassenger_,
      ...
      temperatureSynchronizer_{passengerTemperatureLogic_, commonFactory.temperatureSync_, commonFactory.maxDefroster_,
                               commonFactory.driverTemp_, commonFactory.driverTempHiLoN_},
      maxDefrosterLogic_{commonFactory.maxDefroster_, fanLevelFront_, airDistribution_, autoClimate_, climateReset_},
      steeringWheelHeatLogic_{steeringWheelHeat_, userSelections_.autoSteeringWheelHeat_,
                              userSelections_.autoSteeringWheelHeatLevel_, sf_.steeringWheelHeatLevelProxy_,
                              timeProvider_},
      seatVentDriverLogic_{SeatVentLogic::UserLocation::DRIVER, proxies.seatClimateStatus_, seatVentDriver_,
                           sf_.seatVentLevelDriverProxy_},
      seatVentPassengerLogic_{SeatVentLogic::UserLocation::PASSENGER, proxies.seatClimateStatus_, seatVentPassenger_,
                              sf_.seatVentLevelPassengerProxy_},
      ionizerLogic_{ionizer_, sf_.ionizerProxy_},
      defrosterWindscreenCCSM_{commonFactory.maxDefroster_,
