...
namespace {
enum class Config { Single, Left, Right };
...
TemperatureProxy::TemperatureProxy(
        NotifiableProperty<double>& storedDriverTemp,
        NotifiableProperty<autosar::HmiCmptmtTSpSpcl>& storedDriverTempHiLoN,
        NotifiableProperty<double>& storedPassengerTemp,
        NotifiableProperty<autosar::HmiCmptmtTSpSpcl>& storedPassengerTempHiLoN, NotifiableProperty<double>& driverTemp,
        NotifiableProperty<autosar::HmiCmptmtTSpSpcl>& driverTempHiLoN, NotifiableProperty<double>& passengerTemp,
    ...
    switch (config) {
        case Config::Right: {
            updateDriverTemp = [this](auto temp) {
                this->updateDriver(temp, currentHmiCmptmtTSp_.HmiCmptmtTSpForRowFirstRi);
            };
            updateDriverTempHiLoN = [this](auto tempHiLoN) {
                this->updateDriver(tempHiLoN, currentHmiCmptmtTSp_.HmiCmptmtTSpSpclForRowFirstRi);
            };

            updatePassengerTemp = [this](auto temp) {
                this->updatePassenger(temp, currentHmiCmptmtTSp_.HmiCmptmtTSpForRowFirstLe);
            };
        ...
        case Config::Left: {
            updatePassengerTemp = [this](auto temp) {
                this->updatePassenger(temp, currentHmiCmptmtTSp_.HmiCmptmtTSpForRowFirstRi);
            };
            updatePassengerTempHiLoN = [this](auto tempHiLoN) {
        ...
        case Config::Single: {
            updateDriverTemp = [this](auto temp) {
                this->updateDriver(temp, currentHmiCmptmtTSp_.HmiCmptmtTSpForRowFirstLe);
            };
            updateDriverTempHiLoN = [this](auto tempHiLoN) {
...
void TemperatureProxy::updatePassenger(autosar::HmiCmptmtTSpSpcl tempHiLoN,
                                       autosar::HmiCmptmtTSpSpcl& signalTempHiLoN) {
