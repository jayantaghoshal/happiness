...
AirDistributionLogic::AirDistributionLogic(
    ...
    SettingsProxy<FirstRowGen::AirDistributionAngle::Literal, SettingsFramework::UserScope::USER, SettingsFramework::UserScope::NOT_USER_RELATED>&        settingAirDistribution,
    ...
    maxDefrosterSubscriptionId_ = shareMaxDefroster.subscribe([this](const auto&) {
        ...
        else if (maxDefrosterOn_ && shareMaxDefroster.get() == FirstRowGen::MaxDefrosterState::OFF)
        {
            ...
            else
            {
                ...
                this->setStateAndValue(isActive_,
                                       shareFanLevelFront.get(),
...
void AirDistributionLogic::request(AirDistributionAngleRequest value)
{
    ...
    if (isActive_ && fanLevelFrontIsOn(shareFanLevelFront.get())
        && (static_cast<AirDistributionAngle::Literal>(value.value_) != value_.get())
        && notSettingAutoWithMcc(value))
    {
...
void AirDistributionLogic::setStateAndValue(bool                            isActive,
