...
TemperatureLogic::TemperatureLogic(bool isValidCarConfig, common::daemon::TemperatureConverter& tempConverter,
                                   NotifiableProperty<double>& convertedTemp, NotifiableProperty<double>& storedTemp,
    ...
    if (isValidCarConfig) {
        ...
        auto handleSignals = [this] {
            ...
            if (signalsOk()) {
                auto active =
                        activationCheck(vehModMngtGlbSafe1_.get().value().UsgModSts,
                                        vehModMngtGlbSafe1_.get().value().CarModSts1_, climateActive_.get().value());
...
bool TemperatureLogic::activationCheck(const autosar::UsgModSts1 usgMode, const autosar::CarModSts1 carMode,
