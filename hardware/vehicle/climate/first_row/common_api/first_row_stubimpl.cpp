...
/* Cleanzone */
const FirstRow::CleanzoneState&
FirstRowStubImpl::getCleanzoneAttribute()
{
...
FirstRowStubImpl::getAirConditionerAttribute()
{
...
void FirstRowStubImpl::requestAirConditioner(
...
FirstRowStubImpl::getAirDistributionAttribute()
{
...
void FirstRowStubImpl::requestAirDistribution(
...
/* Climate Reset */
void FirstRowStubImpl::requestClimateReset(
                                           GenericReply _reply)
{
...
FirstRowStubImpl::getFanLevelFrontAttribute()
{
...
void FirstRowStubImpl::requestFanLevelFront(
...
FirstRowStubImpl::getMaxDefrosterAttribute()
{
...
void FirstRowStubImpl::requestMaxDefroster(
...
FirstRowStubImpl::getAutoClimateAttribute()
{
...
void FirstRowStubImpl::requestAutoClimate(
                                          GenericReply _reply)
{
...
FirstRowStubImpl::getManualRecircAttribute()
{
...
void FirstRowStubImpl::requestManualRecirc(
...
FirstRowStubImpl::getElectricDefrosterWindscreenAttribute()
{
...
void FirstRowStubImpl::requestElectricDefrosterWindscreen(
...
FirstRowStubImpl::getElectricDefrosterRearAttribute()
{
...
void FirstRowStubImpl::requestElectricDefrosterRear(
...
FirstRowStubImpl::getDriverTemperatureAttribute()
{
...
void FirstRowStubImpl::requestDriverTemperature(
                                                double                                     _value,
                                                GenericReply _reply)
{
...
const FirstRow::TemperatureAttribute&
FirstRowStubImpl::getPassengerTemperatureAttribute()
{
    static FirstRow::TemperatureAttribute val;
...
void FirstRowStubImpl::requestPassengerTemperature(
                                                   double                                     _value,
                                                   GenericReply _reply)
{
...
FirstRowStubImpl::getTemperatureSyncAttribute()
{
...
void FirstRowStubImpl::requestTemperatureSync(
...
FirstRowStubImpl::getSeatHeatDriverAttribute()
{
...
void FirstRowStubImpl::requestSeatHeatDriver(
...
const FirstRow::HeatAttribute&
FirstRowStubImpl::getSeatHeatPassengerAttribute()
{
    static FirstRow::HeatAttribute val;
...
void FirstRowStubImpl::requestSeatHeatPassenger(
                                                FirstRow::HeatLevel                        _level,
                                                GenericReply _reply)
{
...
FirstRowStubImpl::getElectricDefrosterWindscreenPopupAttribute()
{
...
void FirstRowStubImpl::requestElectricDefrosterWindscreenPopup(
                                                               FirstRow::ElectricDefrosterPopupRequest        _state,
                                                               GenericReply _reply)
{
...
const FirstRow::ElectricDefrosterPopupState&
FirstRowStubImpl::getElectricDefrosterRearPopupAttribute()
{
    static FirstRow::ElectricDefrosterPopupState val;
...
void FirstRowStubImpl::requestElectricDefrosterRearPopup(
...
const FirstRow::HeatAttribute&
FirstRowStubImpl::getSteeringWheelHeatAttribute()
{
    static FirstRow::HeatAttribute val;
...
void FirstRowStubImpl::requestSteeringWheelHeat(
                                                FirstRow::HeatLevel                        _level,
                                                GenericReply _reply)
{
...
FirstRowStubImpl::getSeatVentDriverAttribute()
{
...
void FirstRowStubImpl::requestSeatVentDriver(
...
const FirstRow::VentAttribute&
FirstRowStubImpl::getSeatVentPassengerAttribute()
{
    static FirstRow::VentAttribute val;
...
void FirstRowStubImpl::requestSeatVentPassenger(
                                                FirstRow::VentLevel                        _level,
                                                GenericReply _reply)
{
...
void FirstRowStubImpl::requestIonizer(
