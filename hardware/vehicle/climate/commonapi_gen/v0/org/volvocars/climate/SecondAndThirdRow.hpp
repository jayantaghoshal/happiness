...
*/
#ifndef V0_ORG_VOLVOCARS_CLIMATE_SECOND_AND_THIRD_ROW_HPP_
#define V0_ORG_VOLVOCARS_CLIMATE_SECOND_AND_THIRD_ROW_HPP_
...
public:
    ...
    struct FanLevelRearRequest : CommonApiEnumeration<int32_t> {
        ...
        FanLevelRearRequest() 
            : CommonApiEnumeration<int32_t>(static_cast<int32_t>(Literal::LVL1)) {}
        FanLevelRearRequest(Literal _literal) 
    ...
    struct FanLevelRearState  : CommonApiEnumeration<int32_t>{
        ...
        FanLevelRearState() 
            : CommonApiEnumeration<int32_t>(static_cast<int32_t>(Literal::LVL1)) {}
        FanLevelRearState(Literal _literal) 
            : CommonApiEnumeration<int32_t>(static_cast<int32_t>(_literal)) {}
    ...
    struct SecondRowClimateRequest  : CommonApiEnumeration<int32_t>{
        ...
        SecondRowClimateRequest() 
            : CommonApiEnumeration<int32_t>(static_cast<int32_t>(Literal::OFF)) {}
        SecondRowClimateRequest(Literal _literal) 
            : CommonApiEnumeration<int32_t>(static_cast<int32_t>(_literal)) {}
    ...
    struct SecondRowClimateState  : CommonApiEnumeration<int32_t>{
        ...
        SecondRowClimateState() 
            : CommonApiEnumeration<int32_t>(static_cast<int32_t>(Literal::OFF)) {}
        SecondRowClimateState(Literal _literal) 
            : CommonApiEnumeration<int32_t>(static_cast<int32_t>(_literal)) {}
    ...
    struct TemperatureAttribute : CommonAPI::Struct<::v0::org::volvocars::climate::CommonTypes::TemperatureState, double, Range> {
    	
    	TemperatureAttribute() {
    	}
    	TemperatureAttribute(const ::v0::org::volvocars::climate::CommonTypes::TemperatureState &_currState, const double &_value, const Range &_range)
    	{
    		std::get<0>(values_) = _currState;
    		std::get<1>(values_) = _value;
    		std::get<2>(values_) = _range;
    	}
    	inline const ::v0::org::volvocars::climate::CommonTypes::TemperatureState &getCurrState() const { return std::get<0>(values_); }
    	inline void setCurrState(const ::v0::org::volvocars::climate::CommonTypes::TemperatureState &_value) { std::get<0>(values_) = _value; }
...
#endif // V0_ORG_VOLVOCARS_CLIMATE_SECOND_AND_THIRD_ROW_HPP_
