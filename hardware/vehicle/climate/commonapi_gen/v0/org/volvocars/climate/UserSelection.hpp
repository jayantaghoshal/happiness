...
class UserSelection {
  public:
    ...
    struct OffOnType : CommonApiEnumeration<int32_t> {
        ...
        OffOnType() : CommonApiEnumeration<int32_t>(static_cast<int32_t>(Literal::OFF)) {}
        OffOnType(Literal _literal) : CommonApiEnumeration<int32_t>(static_cast<int32_t>(_literal)) {}
    ...
    struct LevelType : CommonApiEnumeration<int32_t> {
        enum Literal : int32_t { LO = 0, MED = 1, HI = 2 };

        LevelType() : CommonApiEnumeration<int32_t>(static_cast<int32_t>(Literal::LO)) {}
        LevelType(Literal _literal) : CommonApiEnumeration<int32_t>(static_cast<int32_t>(_literal)) {}
    ...
    struct LevelSelection : CommonAPI::Struct<StateType, LevelType> {
        ...
        inline bool operator!=(const LevelSelection& _other) const { return !((*this) == _other); }
    };
    struct OffOnSelection : CommonAPI::Struct<StateType, OffOnType> {
        ...
        inline bool operator==(const OffOnSelection& _other) const {
            return (getCurrentState() == _other.getCurrentState() &&
                    getCurrentSelection() == _other.getCurrentSelection());
        }
        inline bool operator!=(const OffOnSelection& _other) const { return !((*this) == _other); }
    };

    struct PreconditioningHeatSourceEnum : CommonApiEnumeration<int32_t> {
        enum Literal : int32_t { AUTO = 0, FUEL = 1, ELECTRIC = 2 };

        PreconditioningHeatSourceEnum() : CommonApiEnumeration<int32_t>(static_cast<int32_t>(Literal::AUTO)) {}
    ...
    struct PreconditioningHeatSourceStruct : CommonAPI::Struct<StateType, PreconditioningHeatSourceEnum> {
        ...
        PreconditioningHeatSourceStruct(const StateType& _currentState,
                                        const PreconditioningHeatSourceEnum& _currentSelection) {
            std::get<0>(values_) = _currentState;
            std::get<1>(values_) = _currentSelection;
        }
        inline const StateType& getCurrentState() const { return std::get<0>(values_); }
        ...
        inline bool operator!=(const PreconditioningHeatSourceStruct& _other) const { return !((*this) == _other); }
    };
};
