...
const UserSelection::OffOnSelection&
UserSelectionStubImpl::getAutoDriverSeatHeatAttribute()
{
...
const UserSelection::LevelSelection&
UserSelectionStubImpl::getAutoDriverSeatHeatLevelAttribute()
{
...
const UserSelection::OffOnSelection&
UserSelectionStubImpl::getAutoPassengerSeatHeatAttribute()
{
    static UserSelection::OffOnSelection val;
...
const UserSelection::LevelSelection&
UserSelectionStubImpl::getAutoPassengerSeatHeatLevelAttribute()
{
    static UserSelection::LevelSelection val;
...
const UserSelection::OffOnSelection&
UserSelectionStubImpl::getAutoSteeringWheelHeatAttribute()
{
    static UserSelection::OffOnSelection val;
...
const UserSelection::LevelSelection&
UserSelectionStubImpl::getAutoSteeringWheelHeatLevelAttribute()
{
    static UserSelection::LevelSelection val;
...
const UserSelection::OffOnSelection&
UserSelectionStubImpl::getAirQualitySensorAttribute()
{
    static UserSelection::OffOnSelection val;
...
const UserSelection::OffOnSelection&
UserSelectionStubImpl::getManualRecircTimerAttribute()
{
    static UserSelection::OffOnSelection val;
...
const UserSelection::OffOnSelection&
UserSelectionStubImpl::getAutoFrontDefrosterAttribute()
{
    static UserSelection::OffOnSelection val;
...
const UserSelection::OffOnSelection&
UserSelectionStubImpl::getAutoRearDefrosterAttribute()
{
    static UserSelection::OffOnSelection val;
...
const UserSelection::PreconditioningHeatSourceStruct&
UserSelectionStubImpl::getPreconditioningHeatSourceAttribute()
{
...
const UserSelection::OffOnSelection&
UserSelectionStubImpl::getAdditionalHeaterAttribute()
{
    static UserSelection::OffOnSelection val;
...
void UserSelectionStubImpl::requestAutoDriverSeatHeat(
                                                      UserSelection::OffOnType                   _autoHeatSelection,
...
void UserSelectionStubImpl::requestAutoDriverSeatHeatLevel(
                                                           UserSelection::LevelType                   _autoHeatLevel,
                                                           GenericReply2 _reply)
{
...
void UserSelectionStubImpl::requestAutoPassengerSeatHeat(
                                                         UserSelection::OffOnType                   _autoHeatSelection,
                                                         GenericReply2 _reply)
{
...
void UserSelectionStubImpl::requestAutoPassengerSeatHeatLevel(
                                                              UserSelection::LevelType                   _autoHeatLevel,
                                                              GenericReply2 _reply)
{
...
void UserSelectionStubImpl::requestAutoSteeringWheelHeat(
                                                         UserSelection::OffOnType                   _autoHeatSelection,
                                                         GenericReply2 _reply)
{
...
void UserSelectionStubImpl::requestAutoSteeringWheelHeatLevel(
                                                              UserSelection::LevelType                   _autoHeatLevel,
                                                              GenericReply2 _reply)
{
...
void UserSelectionStubImpl::requestAirQualitySensor(
                                                    UserSelection::OffOnType                   _selection,
                                                    GenericReply2 _reply)
{
...
void UserSelectionStubImpl::requestManualRecircTimer(
                                                     UserSelection::OffOnType                   _selection,
                                                     GenericReply2 _reply)
{
...
void UserSelectionStubImpl::requestAutoFrontDefroster(
                                                      UserSelection::OffOnType                   _selection,
                                                      GenericReply2 _reply)
{
...
void UserSelectionStubImpl::requestPreconditioningHeatSource(
                                                             UserSelection::PreconditioningHeatSourceEnum _selection,
                                                             GenericReply2 _reply)
{
...
void UserSelectionStubImpl::requestAutoRearDefroster(
                                                     UserSelection::OffOnType                   _selection,
                                                     GenericReply2 _reply)
{
...
void UserSelectionStubImpl::requestAdditionalHeater(
                                                    UserSelection::OffOnType                   _selection,
                                                    GenericReply2 _reply)
{
