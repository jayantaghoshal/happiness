...
UserSelectionFactory::UserSelectionFactory(android::sp<SettingsFramework::SettingsManager> settingsManager)
    ...
    , autoDriverSeatHeatLogic_{ autoDriverSeatHeat_,
                                setting_factory::createAutoDriverSeatHeatProxy(settingsManager),
    ...
    , airQualitySensorLogic_{ airQualitySensor_,
                              setting_factory::createAirQualitySensorProxy(settingsManager),
    ...
    , preconditioningHeatSource_{ { UserSelectionGen::StateType::NOT_PRESENT,
    ...
    , autoFrontDefrosterLogic_{ autoFrontDefroster_,
                                setting_factory::createAutoFrontDefrosterProxy(settingsManager),
