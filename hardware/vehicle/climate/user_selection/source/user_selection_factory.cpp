...
UserSelectionFactory::UserSelectionFactory(const vcc::LocalConfigReaderInterface* lcfg,
    ...
    : settingsFactory_{settingsManager},
      ...
      autoDriverSeatHeatLogic_{autoDriverSeatHeat_,
                               settingsFactory_.createAutoDriverSeatHeatProxy(settingsManager),
      ...
      airQualitySensorLogic_{airQualitySensor_,
                             settingsFactory_.createAirQualitySensorProxy(settingsManager),
      ...
      autoFrontDefrosterLogic_{autoFrontDefroster_,
                               settingsFactory_.createAutoFrontDefrosterProxy(settingsManager),
      ...
      vfcUserInputSettings_{airQualitySensor_,
                            manualRecircTimer_,
                            autoPassengerSeatHeat_,
                            autoPassengerSeatHeatLevel_,
                            autoDriverSeatHeat_,
                            autoDriverSeatHeatLevel_,
                            autoSteeringWheelHeat_,
                            autoSteeringWheelHeatLevel_,
                            additionalHeater_,
                            preconditioningHeatSource_,
                            autoFrontDefroster_,
                            autoRearDefroster_}  // TODO: Add ThirdRowClimate to vfcUserInputSettings
{
