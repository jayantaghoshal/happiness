...
class FanLevelFrontTest : public ::testing::Test {
  ...
  protected:
    std::unique_ptr<FanLevelFrontLogic> createFanLevelFrontLogic() {
        return std::make_unique<FanLevelFrontLogic>(&localConfig_,
...
INSTANTIATE_TEST_CASE_P(testCarConfig,
                        FanLevelFrontCarConfigTest,
                        Values(CC175::Electronic_Climate_Control_2_zone,
                               CC175::Electronic_Climate_Control_4_zone,
                               CC175::HVAC_Small_1_zone,
                               CC175::HVAC_Small_2_zone,
                               CC175::HVAC_Small_3_zone,
                               CC175::InvalidValue,
                               CC175::Manual_AC));
