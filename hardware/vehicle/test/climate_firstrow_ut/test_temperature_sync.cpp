  ...
  protected:
    void createSut() {
        sut_ = std::make_unique<TemperatureSyncLogic>(
                temperatureSync_, driverTemp_, driverTempHiLoN_, passengerTemp_, passengerTempHiLoN_, rearLeftTemp_,
                rearLeftTempHiLoN_, rearRightTemp_, rearRightTempHiLoN_, maxDefroster_,
...
INSTANTIATE_TEST_CASE_P(CarConfigCheck_WhenCarConfigNotOk_WillSetSyncStateNotVisible, TemperatureSyncCarConfigNotOkTest,
...
INSTANTIATE_TEST_CASE_P(CarConfigCheck_WhenCarConfigNotOk_WillSetSyncStateNotVisible, TemperatureSyncCarConfigkOkTest,
...
INSTANTIATE_TEST_CASE_P(, TemperatureSyncActivationCheckTest,
                        Combine(Values(autosar::UsgModSts1::UsgModAbdnd, autosar::UsgModSts1::UsgModInActv,
                                ...
                                Values(autosar::CarModSts1::CarModTrnsp, autosar::CarModSts1::CarModFcy,
