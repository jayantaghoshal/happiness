...
class TemperatureTest : public ::testing::Test {
  ...
  protected:
    ...
    void createSut() {
        sut_ = std::make_unique<TemperatureLogic>(true, tempConverter_, convertedTemp_, storedTemp_, storedTempHiLoN_,
                                                  temp_, tempHiLoN_, state_, fanLevelFront_, maxDefroster_,
                                                  climateResetEvent_);
    }
...
TEST_F(TemperatureTest, Constructor_WillInitialize) {
    ...
    TemperatureLogic sut(true, tempConverter_, convertedTemp_, storedTemp_, storedTempHiLoN_, temp_, tempHiLoN_, state_,
                         fanLevelFront_, maxDefroster_, climateResetEvent_);
...
TEST_F(TemperatureTest, Constructor_WhenCarConfigNotOk_WillBeNotPresent) {
    TemperatureLogic sut(false, tempConverter_, convertedTemp_, storedTemp_, storedTempHiLoN_, temp_, tempHiLoN_,
                         state_, fanLevelFront_, maxDefroster_, climateResetEvent_);
...
INSTANTIATE_TEST_CASE_P(IsPassengerCarConfigValid_WhenValid_WillReturnTrue, TemperaturePassengerCarConfigTest,
...
INSTANTIATE_TEST_CASE_P(Constructor_WillActivate_WhenOk, TemperatureActivationTest,
                        Combine(Values(UsgModSts1::UsgModAbdnd, UsgModSts1::UsgModInActv, UsgModSts1::UsgModCnvinc,
                                       UsgModSts1::UsgModActv, UsgModSts1::UsgModDrvg),
                                Values(CarModSts1::CarModNorm, CarModSts1::CarModTrnsp, CarModSts1::CarModFcy,
                                       CarModSts1::CarModCrash, CarModSts1::CarModDyno),
