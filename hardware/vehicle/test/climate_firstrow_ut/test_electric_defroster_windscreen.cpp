...
INSTANTIATE_TEST_CASE_P(testCarConfig, ElectricDefrosterWindscreenCarconfigTest,
...
INSTANTIATE_TEST_CASE_P(testActivationCheck, ElectricDefrosterWindscreenActivationCheckTest,
                        Combine(Values(CarModSts1::CarModCrash, CarModSts1::CarModDyno, CarModSts1::CarModFcy,
                                       CarModSts1::CarModNorm, CarModSts1::CarModTrnsp),
                                Values(UsgModSts1::UsgModAbdnd, UsgModSts1::UsgModActv, UsgModSts1::UsgModCnvinc,
                                       UsgModSts1::UsgModDrvg, UsgModSts1::UsgModInActv)));
...
INSTANTIATE_TEST_CASE_P(testAutoInitCheck, ElectricDefrosterWindscreenAutoInitCheckCheckTest,
                        Combine(Values(DrvModReqType1::DrvMod1, DrvModReqType1::DrvMod2, DrvModReqType1::DrvMod3,
                                       DrvModReqType1::DrvMod4, DrvModReqType1::DrvMod5, DrvModReqType1::DrvMod6,
                                       DrvModReqType1::DrvMod7, DrvModReqType1::DrvMod8, DrvModReqType1::DrvMod9,
                                       DrvModReqType1::DrvMod10, DrvModReqType1::DrvMod11, DrvModReqType1::DrvMod12,
                                       DrvModReqType1::DrvMod13, DrvModReqType1::DrvMod14, DrvModReqType1::Err,
...
INSTANTIATE_TEST_CASE_P(testGotoManual, ElectricDefrosterWindscreenToManualTest,
                        Combine(Values(FirstRowGen::ElectricDefrosterWindscreenRequest::ON,
                                       FirstRowGen::ElectricDefrosterWindscreenRequest::OFF),
                                Values(ActrDefrstSts::AutoCdn, ActrDefrstSts::Limited, ActrDefrstSts::NotAvailable,
                                       ActrDefrstSts::Off, ActrDefrstSts::On, ActrDefrstSts::TmrOff)));
...
INSTANTIATE_TEST_CASE_P(testDriveMode, ElectricDefrosterWindscreenAutoDefrosterOnTest,
...
INSTANTIATE_TEST_CASE_P(testDriveMode, ElectricDefrosterWindscreenAutoDefrosterOffTest,
