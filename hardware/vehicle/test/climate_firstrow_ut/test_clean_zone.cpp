...
INSTANTIATE_TEST_CASE_P(testCarConfig, CleanzoneCarConfigTest,
...
INSTANTIATE_TEST_CASE_P(
        testLevelOfComfort, CleanzoneLevelOfComfortTest,
...
INSTANTIATE_TEST_CASE_P(testVehicleModes, CleanzoneVehicleModesTest,
                        Combine(Values(UsgModSts1::UsgModAbdnd, UsgModSts1::UsgModActv, UsgModSts1::UsgModCnvinc,
                                       UsgModSts1::UsgModDrvg, UsgModSts1::UsgModInActv),
                                Values(CarModSts1::CarModCrash, CarModSts1::CarModDyno, CarModSts1::CarModFcy,
                                       CarModSts1::CarModNorm, CarModSts1::CarModTrnsp),
                                Values(OnOff1::Off, OnOff1::On),
                                Values(LvlOfClimaCmft::Off, LvlOfClimaCmft::Lvl1, LvlOfClimaCmft::Lvl2,
                                       LvlOfClimaCmft::Lvl3, LvlOfClimaCmft::Lvl4, LvlOfClimaCmft::Lvl5,
                                       LvlOfClimaCmft::Lvl6, LvlOfClimaCmft::Lvl7),
                                Values(false, true), Values(false, true), Values(false, true)));
