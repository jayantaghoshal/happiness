...
std::unique_ptr<tarmac::timeprovider::TimerSubscriptionHandle> TimeProviderStub::AddSingleShotTimer(
        std::chrono::milliseconds time, std::function<void()> func) {
...
TimeProviderStub::InternalSubscriptionHandle::InternalSubscriptionHandle(
        std::chrono::steady_clock::time_point fire_at, std::weak_ptr<TimeProviderStub::SubscriptionData> meta)
...
std::unique_ptr<tarmac::timeprovider::TimerSubscriptionHandle> TimeProviderStub::AddPeriodicTimer(
        std::chrono::milliseconds interval, std::function<void()> func) {
...
TimeProviderStub::ProxyHandle::ProxyHandle(std::chrono::milliseconds interval, std::function<void()> func,
