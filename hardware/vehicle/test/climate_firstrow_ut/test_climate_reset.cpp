...
INSTANTIATE_TEST_CASE_P(
        test_activation_of_climate_reset_fails,
        ClimateResetActivationTest,
        Values(std::make_tuple(autosar::UsgModSts1::UsgModAbdnd, autosar::CarModSts1::CarModNorm, autosar::OnOff1::Off),
               ...
               std::make_tuple(autosar::UsgModSts1::UsgModAbdnd,
...
INSTANTIATE_TEST_CASE_P(
        test_activation_of_climate_reset_is_ok,
        ClimateResetDeActivationTest,
...
INSTANTIATE_TEST_CASE_P(test_activation_of_climate_reset_is_ok,
                        ClimateResetNoCCTest,
                        Values(0,
