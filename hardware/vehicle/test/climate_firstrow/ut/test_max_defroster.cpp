...
TEST_F(MaxDefrosterTest, test_request_from_hmi_updates_state) {
    ...
    MaxDefrosterLogic logic{
            shareMaxDefroster, shareFanLevelFront, shareAirDistribution, shareAutoClimate, shareClimateReset};
...
class MaxDefrosterActivationTest : public MaxDefrosterTest,
                                   public WithParamInterface<std::tuple<FirstRowGen::MaxDefrosterState,
                                                                        FirstRowGen::MaxDefrosterRequest,
                                                                        autosar::UsgModSts1,
                                                                        autosar::CarModSts1,
                                                                        autosar::OnOff1>> {};
...
INSTANTIATE_TEST_CASE_P(test_request_passes_fails_depending_on_activation_status,
                        MaxDefrosterActivationTest,
                        Values(std::make_tuple(FirstRowGen::MaxDefrosterState::DISABLED,
                                               FirstRowGen::MaxDefrosterRequest::ON,
                                               autosar::UsgModSts1::UsgModAbdnd,
                                               autosar::CarModSts1::CarModNorm,
                                               autosar::OnOff1::Off),
                               std::make_tuple(FirstRowGen::MaxDefrosterState::ON,
                                               FirstRowGen::MaxDefrosterRequest::ON,
                               ...
                               std::make_tuple(FirstRowGen::MaxDefrosterState::ON,
                                               ...
                                               autosar::CarModSts1::CarModDyno,
                                               autosar::OnOff1::On),
                               std::make_tuple(FirstRowGen::MaxDefrosterState::DISABLED,
                                               FirstRowGen::MaxDefrosterRequest::OFF,
                                               autosar::UsgModSts1::UsgModDrvg,
