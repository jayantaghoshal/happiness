...
class TemperatureProxyTest : public Test, public testing::WithParamInterface<std::tuple<CC175, CC8>> {
  ...
  protected:
    void createSut() {
        sut_ = std::unique_ptr<TemperatureProxy>(new TemperatureProxy(storedDriverTemp_,
                                                                      storedDriverTempHiLoN_,
                                                                      storedPassengerTemp_,
                                                                      storedPassengerTempHiLoN_,
                                                                      driverTemp_,
                                                                      driverTempHiLoN_,
                                                                      passengerTemp_,
                                                                      passengerTempHiLoN_,
...
INSTANTIATE_TEST_CASE_P(,
                        TemperatureProxyCCSingleTest,
                        Combine(Values(CC175::HVAC_Small_1_zone, CC175::Manual_AC),
...
INSTANTIATE_TEST_CASE_P(,
                        TemperatureProxyCCLeftTest,
                        Combine(Values(CC175::Electronic_Climate_Control_2_zone,
                                       CC175::Electronic_Climate_Control_4_zone,
                                       CC175::HVAC_Small_2_zone),
