...
class AirDistributionTest : public Test {
  ...
  protected:
    ...
    CompatSetting<FirstRowGen::AirDistributionAngle::Literal, SettingsFramework::UserScope::USER> sAirDistribution{
            SettingId::TestSetting1,
            AirDistributionAngle::FLOOR,
            settingsManager};
    ...
    SettingsProxy<FirstRowGen::AirDistributionAngle::Literal,
...
TEST_F(AirDistributionTest, test_default_state_dyno) {
    ...
    AirDistributionLogic airDistributionLogic(airDistributionAngle_,
                                              sAirDistributionProxy,
                                              shareClimateResetEvent,
                                              shareFanLevel,
                                              shareAutoClimate,
                                              shareMaxDefroster);
...
TEST_F(AirDistributionTest, test_setting_angles_ecc) {
    ...
    for (auto angle : {AirDistributionAngleRequest::AUTO,
                       AirDistributionAngleRequest::FLOOR,
                       AirDistributionAngleRequest::VENT,
                       AirDistributionAngleRequest::DEFROST,
                       AirDistributionAngleRequest::FLOOR_VENT,
                       AirDistributionAngleRequest::FLOOR_DEFROST,
                       AirDistributionAngleRequest::VENT_DEFROST,
                       AirDistributionAngleRequest::FLOOR_VENT_DEFROST}) {
...
TEST_F(AirDistributionTest, test_setting_angles_mcc) {
    ...
    for (auto angle : {AirDistributionAngleRequest::FLOOR,
                       AirDistributionAngleRequest::VENT,
                       AirDistributionAngleRequest::DEFROST,
                       AirDistributionAngleRequest::FLOOR_VENT,
                       AirDistributionAngleRequest::FLOOR_DEFROST,
