...
INSTANTIATE_TEST_CASE_P(
        test_that_vfc_should_be_off_if_not_in_driving,
        VFCClimatisationNotActiveTest,
        Values(UsgModSts1::UsgModAbdnd, UsgModSts1::UsgModInActv, UsgModSts1::UsgModCnvinc, UsgModSts1::UsgModActv));
...
TEST_F(VFCClimatisationTest, test_that_vf_is_on_when_all_seat_heat_is_on_and_in_driving) {
    ...
    HmiSeatClima heat{SeatClimaLvl::Lvl1,
                      SeatClimaLvl::Lvl1,
                      SeatClimaLvl::Lvl1,
                      SeatClimaLvl::Lvl1,
                      SeatClimaLvl::Lvl1,
...
TEST_F(VFCClimatisationTest, test_that_vf_is_on_when_one_seat_heat_is_on_and_in_driving) {
    ...
    HmiSeatClima heat{SeatClimaLvl::Off,
                      SeatClimaLvl::Lvl1,
                      SeatClimaLvl::Off,
                      SeatClimaLvl::Off,
                      SeatClimaLvl::Off,
