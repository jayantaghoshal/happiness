...
TrafficSignInformationModule::TrafficSignInformationModule(vhal20::impl::IVehicleHalImpl* vehicleHal,
                                                           std::shared_ptr<tarmac::eventloop::IDispatcher> dispatcher,
                                                           android::sp<SettingsFramework::SettingsManagerHidl> manager)
    : PA_prop_tsi_rsi_(propconfig_tsi_setting_on(), vccvhal10::VehicleProperty::TSI_RSI_STATUS, dispatcher, vehicleHal),
      ...
      setting_tsi_rsi_(SettingId::TrafficSignInfo_RsiOn, is_TSI_Default_On_Country(car_config_149), manager),
      setting_tsi_speedcamaudiowarn_(SettingId::TrafficSignInfo_SpeedCamAudioWarnOn, false, manager),
      setting_tsi_speedvisualwarn_(SettingId::TrafficSignInfo_SpeedVisualWarnOn, true, manager),
      setting_tsi_speedaudiowarn_(SettingId::TrafficSignInfo_SpeedAudioWarnOn, false, manager),
      setting_tsi_speedwarnoffset_(SettingId::TrafficSignInfo_SpeedWarnOffset, 0, manager),
