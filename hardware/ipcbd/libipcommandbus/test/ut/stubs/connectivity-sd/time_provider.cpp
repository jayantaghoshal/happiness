...
ITimeProvider::PeriodicTimerSubscriptionHandle::~PeriodicTimerSubscriptionHandle() { handle->handle.reset(nullptr); }

// /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// ProxyHandle
// /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

ITimeProvider::ProxyHandle::ProxyHandle(std::chrono::milliseconds interval, std::function<void()> func,
