...
void vsm_inject_start(void)
{
  ...
  std::thread monitorThread([]() {
    ...
    while (true)
    {
      ...
      {  // We didn't receive any heartbeats during the period and we didn't log it (yet)
      ...
      {  // We did receive heartbeats during the period and this was the first detection of it
      ...
      {  // We didn't receive any signals during the period and we didn't log it (yet)
      ...
      {  // We did receive signals during the period and this was the first detection of it
