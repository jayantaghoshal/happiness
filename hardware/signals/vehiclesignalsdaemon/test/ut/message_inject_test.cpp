...
/**
 * Unit test of the message inject function/module.
 *
 * Production code under test:
 *   vipcommunication/vehiclesignalsmanager/src/message_inject.cpp
 *
 */
...
TEST_F(HisipMessageInjectTestFixture, avmpMessageInject_givenVersionCheckMsg_shallCallVsmSinkInit)
{
   ...
   uint8_t data[] = {0x3, 0x80, avmp::avmpVersion,
                     static_cast<uint8_t>(comCrc & 0x00FF), static_cast<uint8_t>(comCrc >> 8),
                     static_cast<uint8_t>(swcCrc & 0x00FF), static_cast<uint8_t>(swcCrc >> 8),
                     static_cast<uint8_t>(rteTypeCrc & 0x00FF), static_cast<uint8_t>(rteTypeCrc >> 8),
                     static_cast<uint8_t>(comCfgCrc & 0x00FF), static_cast<uint8_t>(comCfgCrc >> 8)};
...
TEST_F(HisipMessageInjectTestFixture, avmpMessageInject_givenVersionCheckMsgInvalid_shallNotCallVsmSinkInit)
{
   ...
   uint8_t data[] = {0x3, 0x80, invalidAvmpVersion,
                     static_cast<uint8_t>(comCrc & 0x00FF), static_cast<uint8_t>(comCrc >> 8),
                     static_cast<uint8_t>(swcCrc & 0x00FF), static_cast<uint8_t>(swcCrc >> 8),
                     static_cast<uint8_t>(rteTypeCrc & 0x00FF), static_cast<uint8_t>(rteTypeCrc >> 8),
                     static_cast<uint8_t>(comCfgCrc & 0x00FF), static_cast<uint8_t>(comCfgCrc >> 8)};
