...
// AsyLaneChg1
template <>
json toJson<AsyLaneChg1>(const AsyLaneChg1& v) {
    json j;
    j["Typ"] = toJson<AsyLaneChgTyp1>(v.Typ);
    j["Sts"] = toJson<AsyLaneChgSts1>(v.Sts);
    j["Psbl"] = toJson<AsyLaneChgPsbl1>(v.Psbl);
    return j;
}
template <>
AsyLaneChg1 fromJson<AsyLaneChg1>(const json& object) {
    if (!object.is_object()) {
        return AsyLaneChg1();
    }
    AsyLaneChg1 v;
    v.Typ = fromJson<AsyLaneChgTyp1>(object["Typ"]);
    v.Sts = fromJson<AsyLaneChgSts1>(object["Sts"]);
    v.Psbl = fromJson<AsyLaneChgPsbl1>(object["Psbl"]);
    return v;
}
...
template <>
json toJson<AutnmsPrkgActvScenario>(const AutnmsPrkgActvScenario& v) {
    json j;
    j["APActiveState"] = toJson<AutnmsPrkgActvSt>(v.APActiveState);
    j["APActiveParkingSide"] = toJson<AutnmsPrkgActvPrkgSide>(v.APActiveParkingSide);
    j["APActiveSlotType"] = toJson<AutnmsPrkgActvSlotTyp>(v.APActiveSlotType);
    j["APActiveParkingScenario"] = toJson<AutnmsPrkgActvPrkgScenario>(v.APActiveParkingScenario);
    j["APActiveParkingDirection"] = toJson<AutnmsPrkgActvPrkgDir>(v.APActiveParkingDirection);
    j["APActiveRemote"] = toJson<AutnmsPrkgActvRem>(v.APActiveRemote);
    j["APPauseStatus"] = toJson<AutnmsPrkgPauseSts>(v.APPauseStatus);
    j["APCancelStatus"] = toJson<AutnmsPrkgCnclSts>(v.APCancelStatus);
    j["APActiveDirectParking"] = toJson<AutnmsPrkgActvDirectPrkg>(v.APActiveDirectParking);
    return j;
}
template <>
AutnmsPrkgActvScenario fromJson<AutnmsPrkgActvScenario>(const json& object) {
    if (!object.is_object()) {
        return AutnmsPrkgActvScenario();
    }
    AutnmsPrkgActvScenario v;
    v.APActiveState = fromJson<AutnmsPrkgActvSt>(object["APActiveState"]);
    v.APActiveParkingSide = fromJson<AutnmsPrkgActvPrkgSide>(object["APActiveParkingSide"]);
    v.APActiveSlotType = fromJson<AutnmsPrkgActvSlotTyp>(object["APActiveSlotType"]);
    v.APActiveParkingScenario = fromJson<AutnmsPrkgActvPrkgScenario>(object["APActiveParkingScenario"]);
    v.APActiveParkingDirection = fromJson<AutnmsPrkgActvPrkgDir>(object["APActiveParkingDirection"]);
    v.APActiveRemote = fromJson<AutnmsPrkgActvRem>(object["APActiveRemote"]);
    v.APPauseStatus = fromJson<AutnmsPrkgPauseSts>(object["APPauseStatus"]);
    v.APCancelStatus = fromJson<AutnmsPrkgCnclSts>(object["APCancelStatus"]);
    v.APActiveDirectParking = fromJson<AutnmsPrkgActvDirectPrkg>(object["APActiveDirectParking"]);
    return v;
}
...
template <>
json toJson<AutnmsPrkgAvlScenario>(const AutnmsPrkgAvlScenario& v) {
    json j;
    j["APAvailableParkingSide"] = toJson<AutnmsPrkgAvlPrkgSide>(v.APAvailableParkingSide);
    j["APAvailableParkingScenario"] = toJson<AutnmsPrkgAvlPrkgScenario>(v.APAvailableParkingScenario);
    j["APAvailableSlotType"] = toJson<AutnmsPrkgAvlSlotTyp>(v.APAvailableSlotType);
    j["APAvailableParkingDirection"] = toJson<AutnmsPrkgAvlPrkgDir>(v.APAvailableParkingDirection);
    j["APAvailableRemote"] = toJson<AutnmsPrkgAvlRem>(v.APAvailableRemote);
    j["APRecommendedParkingSide"] = toJson<AutnmsPrkgRecmndPrkgSide>(v.APRecommendedParkingSide);
    j["APRecommendedSlotType"] = toJson<AutnmsPrkgRecmndSlotTyp>(v.APRecommendedSlotType);
    j["APRecommendedParkingDirection"] = toJson<AutnmsPrkgRecmndPrkgDir>(v.APRecommendedParkingDirection);
    j["APRecommendedRemote"] = toJson<AutnmsPrkgRecmndRem>(v.APRecommendedRemote);
    j["APRecommendedParkingScenario"] = toJson<AutnmsPrkgRecmndPrkgScenario>(v.APRecommendedParkingScenario);
    j["APAvailableDirectParking"] = toJson<AutnmsPrkgAvlDirectPrkg>(v.APAvailableDirectParking);
    return j;
}
template <>
AutnmsPrkgAvlScenario fromJson<AutnmsPrkgAvlScenario>(const json& object) {
    if (!object.is_object()) {
        return AutnmsPrkgAvlScenario();
    }
    AutnmsPrkgAvlScenario v;
    v.APAvailableParkingSide = fromJson<AutnmsPrkgAvlPrkgSide>(object["APAvailableParkingSide"]);
    v.APAvailableParkingScenario = fromJson<AutnmsPrkgAvlPrkgScenario>(object["APAvailableParkingScenario"]);
    v.APAvailableSlotType = fromJson<AutnmsPrkgAvlSlotTyp>(object["APAvailableSlotType"]);
    v.APAvailableParkingDirection = fromJson<AutnmsPrkgAvlPrkgDir>(object["APAvailableParkingDirection"]);
    v.APAvailableRemote = fromJson<AutnmsPrkgAvlRem>(object["APAvailableRemote"]);
    v.APRecommendedParkingSide = fromJson<AutnmsPrkgRecmndPrkgSide>(object["APRecommendedParkingSide"]);
    v.APRecommendedSlotType = fromJson<AutnmsPrkgRecmndSlotTyp>(object["APRecommendedSlotType"]);
    v.APRecommendedParkingDirection = fromJson<AutnmsPrkgRecmndPrkgDir>(object["APRecommendedParkingDirection"]);
    v.APRecommendedRemote = fromJson<AutnmsPrkgRecmndRem>(object["APRecommendedRemote"]);
    v.APRecommendedParkingScenario = fromJson<AutnmsPrkgRecmndPrkgScenario>(object["APRecommendedParkingScenario"]);
    v.APAvailableDirectParking = fromJson<AutnmsPrkgAvlDirectPrkg>(object["APAvailableDirectParking"]);
    return v;
}
...
template <>
json toJson<AutnmsPrkgSeldScenario>(const AutnmsPrkgSeldScenario& v) {
    json j;
    j["AutnmsPrkgSeldSlotTyp_"] = toJson<AutnmsPrkgSeldSlotTyp>(v.AutnmsPrkgSeldSlotTyp_);
    j["AutnmsPrkgSeldPrkgScenario_"] = toJson<AutnmsPrkgSeldPrkgScenario>(v.AutnmsPrkgSeldPrkgScenario_);
    j["AutnmsPrkgSeldPrkgDir_"] = toJson<AutnmsPrkgSeldPrkgDir>(v.AutnmsPrkgSeldPrkgDir_);
    j["AutnmsPrkgSeldPrkgSide_"] = toJson<AutnmsPrkgSeldPrkgSide>(v.AutnmsPrkgSeldPrkgSide_);
    j["AutnmsPrkgSeldRem_"] = toJson<AutnmsPrkgSeldRem>(v.AutnmsPrkgSeldRem_);
    j["AutnmsPrkgSeldDirectPrkg_"] = toJson<AutnmsPrkgSeldDirectPrkg>(v.AutnmsPrkgSeldDirectPrkg_);
    return j;
}
template <>
AutnmsPrkgSeldScenario fromJson<AutnmsPrkgSeldScenario>(const json& object) {
    if (!object.is_object()) {
        return AutnmsPrkgSeldScenario();
    }
    AutnmsPrkgSeldScenario v;
    v.AutnmsPrkgSeldSlotTyp_ = fromJson<AutnmsPrkgSeldSlotTyp>(object["AutnmsPrkgSeldSlotTyp_"]);
    v.AutnmsPrkgSeldPrkgScenario_ = fromJson<AutnmsPrkgSeldPrkgScenario>(object["AutnmsPrkgSeldPrkgScenario_"]);
    v.AutnmsPrkgSeldPrkgDir_ = fromJson<AutnmsPrkgSeldPrkgDir>(object["AutnmsPrkgSeldPrkgDir_"]);
    v.AutnmsPrkgSeldPrkgSide_ = fromJson<AutnmsPrkgSeldPrkgSide>(object["AutnmsPrkgSeldPrkgSide_"]);
    v.AutnmsPrkgSeldRem_ = fromJson<AutnmsPrkgSeldRem>(object["AutnmsPrkgSeldRem_"]);
    v.AutnmsPrkgSeldDirectPrkg_ = fromJson<AutnmsPrkgSeldDirectPrkg>(object["AutnmsPrkgSeldDirectPrkg_"]);
    return v;
}
...
// CllsnWarnSide1
template <>
json toJson<CllsnWarnSide1>(const CllsnWarnSide1& v) {
    json j;
    j["Le"] = toJson<CllsnWarn1>(v.Le);
    j["Ri"] = toJson<CllsnWarn1>(v.Ri);
    return j;
}
template <>
CllsnWarnSide1 fromJson<CllsnWarnSide1>(const json& object) {
    if (!object.is_object()) {
        return CllsnWarnSide1();
    }
    CllsnWarnSide1 v;
    v.Le = fromJson<CllsnWarn1>(object["Le"]);
    v.Ri = fromJson<CllsnWarn1>(object["Ri"]);
    return v;
}
...
template <>
json toJson<DriveAwayInfoWarnReq1>(const DriveAwayInfoWarnReq1& v) {
    json j;
    j["ReqSrc"] = toJson<ReqSrc1>(v.ReqSrc);
    j["TiToDrvCntDwnTi"] = toJson<uint8_t>(v.TiToDrvCntDwnTi);
    j["CtrlDirOfTrfcLi"] = toJson<CtrlDirOfTrfcLi1>(v.CtrlDirOfTrfcLi);
    j["VisWarnReq"] = toJson<VisWarnReq1>(v.VisWarnReq);
    j["AudWarnReq"] = toJson<AudWarnReq1>(v.AudWarnReq);
    j["InterruptionSrc"] = toJson<InterruptionSrc1>(v.InterruptionSrc);
    return j;
}
template <>
DriveAwayInfoWarnReq1 fromJson<DriveAwayInfoWarnReq1>(const json& object) {
    if (!object.is_object()) {
        return DriveAwayInfoWarnReq1();
    }
    DriveAwayInfoWarnReq1 v;
    v.ReqSrc = fromJson<ReqSrc1>(object["ReqSrc"]);
    v.TiToDrvCntDwnTi = fromJson<uint8_t>(object["TiToDrvCntDwnTi"]);
    v.CtrlDirOfTrfcLi = fromJson<CtrlDirOfTrfcLi1>(object["CtrlDirOfTrfcLi"]);
    v.VisWarnReq = fromJson<VisWarnReq1>(object["VisWarnReq"]);
    v.AudWarnReq = fromJson<AudWarnReq1>(object["AudWarnReq"]);
    v.InterruptionSrc = fromJson<InterruptionSrc1>(object["InterruptionSrc"]);
    return v;
}
...
// PrkgAssiAudWarn
template <>
json toJson<PrkgAssiAudWarn>(const PrkgAssiAudWarn& v) {
    json j;
...
template <>
PrkgAssiAudWarn fromJson<PrkgAssiAudWarn>(const json& object) {
    if (!object.is_object()) {
        return PrkgAssiAudWarn();
    }
    PrkgAssiAudWarn v;
...
// SftyCchIdx1
template <>
json toJson<SftyCchIdx1>(const SftyCchIdx1& v) {
    json j;
    j["Tot"] = toJson<double>(v.Tot);
    j["TotAvl"] = toJson<FcnAvlSts1>(v.TotAvl);
    j["DstToVeh"] = toJson<double>(v.DstToVeh);
    j["DstToVehAvl"] = toJson<FcnAvlSts1>(v.DstToVehAvl);
    j["LaneKeep"] = toJson<double>(v.LaneKeep);
    j["LaneKeepAvl"] = toJson<FcnAvlSts1>(v.LaneKeepAvl);
    j["Attention"] = toJson<double>(v.Attention);
    j["AttentionAvl"] = toJson<FcnAvlSts1>(v.AttentionAvl);
    j["KeepSpdLim"] = toJson<double>(v.KeepSpdLim);
    j["KeepSpdLimAvl"] = toJson<FcnAvlSts1>(v.KeepSpdLimAvl);
    return j;
}
template <>
SftyCchIdx1 fromJson<SftyCchIdx1>(const json& object) {
    if (!object.is_object()) {
        return SftyCchIdx1();
    }
    SftyCchIdx1 v;
    v.Tot = fromJson<double>(object["Tot"]);
    v.TotAvl = fromJson<FcnAvlSts1>(object["TotAvl"]);
    v.DstToVeh = fromJson<double>(object["DstToVeh"]);
    v.DstToVehAvl = fromJson<FcnAvlSts1>(object["DstToVehAvl"]);
    v.LaneKeep = fromJson<double>(object["LaneKeep"]);
    v.LaneKeepAvl = fromJson<FcnAvlSts1>(object["LaneKeepAvl"]);
    v.Attention = fromJson<double>(object["Attention"]);
    v.AttentionAvl = fromJson<FcnAvlSts1>(object["AttentionAvl"]);
    v.KeepSpdLim = fromJson<double>(object["KeepSpdLim"]);
    v.KeepSpdLimAvl = fromJson<FcnAvlSts1>(object["KeepSpdLimAvl"]);
    return v;
}
...
// SftyCchIdx2
template <>
json toJson<SftyCchIdx2>(const SftyCchIdx2& v) {
    json j;
    j["Tot"] = toJson<double>(v.Tot);
    j["TotAvl"] = toJson<FcnAvlSts1>(v.TotAvl);
    j["TotCntxt"] = toJson<SftyCchCntxt1>(v.TotCntxt);
    j["DstToVeh"] = toJson<double>(v.DstToVeh);
    j["DstToVehAvl"] = toJson<FcnAvlSts1>(v.DstToVehAvl);
    j["DstToVehCntxt"] = toJson<SftyCchCntxt1>(v.DstToVehCntxt);
    j["LaneKeep"] = toJson<double>(v.LaneKeep);
    j["LaneKeepAvl"] = toJson<FcnAvlSts1>(v.LaneKeepAvl);
    j["LaneKeepCntxt"] = toJson<SftyCchCntxt1>(v.LaneKeepCntxt);
    j["Attention"] = toJson<double>(v.Attention);
    j["AttentionAvl"] = toJson<FcnAvlSts1>(v.AttentionAvl);
    j["AttentionCntxt"] = toJson<SftyCchCntxt1>(v.AttentionCntxt);
    j["KeepSpdLim"] = toJson<double>(v.KeepSpdLim);
    j["KeepSpdLimAvl"] = toJson<FcnAvlSts1>(v.KeepSpdLimAvl);
    j["KeepSpdLimCntxt"] = toJson<SftyCchCntxt1>(v.KeepSpdLimCntxt);
    j["FldTot"] = toJson<double>(v.FldTot);
    j["FldTotAvl"] = toJson<FcnAvlSts1>(v.FldTotAvl);
    return j;
}
template <>
SftyCchIdx2 fromJson<SftyCchIdx2>(const json& object) {
    if (!object.is_object()) {
        return SftyCchIdx2();
    }
    SftyCchIdx2 v;
    v.Tot = fromJson<double>(object["Tot"]);
    v.TotAvl = fromJson<FcnAvlSts1>(object["TotAvl"]);
    v.TotCntxt = fromJson<SftyCchCntxt1>(object["TotCntxt"]);
    v.DstToVeh = fromJson<double>(object["DstToVeh"]);
    v.DstToVehAvl = fromJson<FcnAvlSts1>(object["DstToVehAvl"]);
    v.DstToVehCntxt = fromJson<SftyCchCntxt1>(object["DstToVehCntxt"]);
    v.LaneKeep = fromJson<double>(object["LaneKeep"]);
    v.LaneKeepAvl = fromJson<FcnAvlSts1>(object["LaneKeepAvl"]);
    v.LaneKeepCntxt = fromJson<SftyCchCntxt1>(object["LaneKeepCntxt"]);
    v.Attention = fromJson<double>(object["Attention"]);
    v.AttentionAvl = fromJson<FcnAvlSts1>(object["AttentionAvl"]);
    v.AttentionCntxt = fromJson<SftyCchCntxt1>(object["AttentionCntxt"]);
    v.KeepSpdLim = fromJson<double>(object["KeepSpdLim"]);
    v.KeepSpdLimAvl = fromJson<FcnAvlSts1>(object["KeepSpdLimAvl"]);
    v.KeepSpdLimCntxt = fromJson<SftyCchCntxt1>(object["KeepSpdLimCntxt"]);
    v.FldTot = fromJson<double>(object["FldTot"]);
    v.FldTotAvl = fromJson<FcnAvlSts1>(object["FldTotAvl"]);
    return v;
}
...
// SnsrPrkgAssi2
template <>
json toJson<SnsrPrkgAssi2>(const SnsrPrkgAssi2& v) {
    json j;
    j["SnsrDstInsdLe"] = toJson<double>(v.SnsrDstInsdLe);
    j["SnsrDstOutdLe"] = toJson<double>(v.SnsrDstOutdLe);
    j["SnsrDstSideLe"] = toJson<double>(v.SnsrDstSideLe);
    j["SnsrDstInsdRi"] = toJson<double>(v.SnsrDstInsdRi);
    j["SnsrDstOutdRi"] = toJson<double>(v.SnsrDstOutdRi);
    j["SnsrDstSideRi"] = toJson<double>(v.SnsrDstSideRi);
    j["AudWarnDir"] = toJson<WarnDir1>(v.AudWarnDir);
    j["AudSideWarn"] = toJson<ParkAssiLeRi1>(v.AudSideWarn);
    return j;
}
template <>
SnsrPrkgAssi2 fromJson<SnsrPrkgAssi2>(const json& object) {
    if (!object.is_object()) {
        return SnsrPrkgAssi2();
    }
    SnsrPrkgAssi2 v;
    v.SnsrDstInsdLe = fromJson<double>(object["SnsrDstInsdLe"]);
    v.SnsrDstOutdLe = fromJson<double>(object["SnsrDstOutdLe"]);
    v.SnsrDstSideLe = fromJson<double>(object["SnsrDstSideLe"]);
    v.SnsrDstInsdRi = fromJson<double>(object["SnsrDstInsdRi"]);
    v.SnsrDstOutdRi = fromJson<double>(object["SnsrDstOutdRi"]);
    v.SnsrDstSideRi = fromJson<double>(object["SnsrDstSideRi"]);
    v.AudWarnDir = fromJson<WarnDir1>(object["AudWarnDir"]);
    v.AudSideWarn = fromJson<ParkAssiLeRi1>(object["AudSideWarn"]);
    return v;
}
...
// SnsrPrkgAssi3
template <>
json toJson<SnsrPrkgAssi3>(const SnsrPrkgAssi3& v) {
    json j;
    j["SnsrDstInsdLe"] = toJson<double>(v.SnsrDstInsdLe);
    j["SnsrDstOutdLe"] = toJson<double>(v.SnsrDstOutdLe);
    j["SnsrDstSideLe"] = toJson<double>(v.SnsrDstSideLe);
...
template <>
SnsrPrkgAssi3 fromJson<SnsrPrkgAssi3>(const json& object) {
    if (!object.is_object()) {
        return SnsrPrkgAssi3();
    }
    SnsrPrkgAssi3 v;
    v.SnsrDstInsdLe = fromJson<double>(object["SnsrDstInsdLe"]);
    v.SnsrDstOutdLe = fromJson<double>(object["SnsrDstOutdLe"]);
