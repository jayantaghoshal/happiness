...
TEST_F(TypeConvHelpersTest, EncodeWOSession)
{
  ...
  Icb_SatelliteUsage_t satelliteInfo = {
    &nrOfSatellitesVisible,
    &nrOfSatellitesUsed
  };
  ...
  Icb_ReceiverChannelData_t receiverChannels = {
    0,         // min and max taken from Icb_ReceiverChannelData_EncodedSize()
    127,
    1,
    &channelData_p
  };
  ...
  Icb_OpGNSSPositionData_Response_t gnssPos = {
    &gnssPositionData
  };
  ...
  InfotainmentIpBus::Utils::DecodeMessage(payload,
    ...
    EXPECT_EQ(decodedGnssPos->gnssPositionData->position->altitude,
              gnssPos.gnssPositionData->position->altitude);
    ...
    EXPECT_EQ(decodedGnssPos->gnssPositionData->receiverChannels->data_array[0]->extendedData->data->pseudoRangeCorrectionData,
...
TEST_F(TypeConvHelpersTest, EncodeWithSession)
{
  ...
  gnssPos->gnssPositionData->receiverChannels->data_array[0]->trackingStatus = Icb_SatelliteTrackingStatusType_t::e_Icb_SatelliteTrackingStatusType_tracking;
  ...
  gnssPos->gnssPositionData->receiverChannels->data_array[0]->extendedData->choice = Icb_ExtendedChannelData_Choices::e_Icb_ExtendedChannelData_data;
  gnssPos->gnssPositionData->receiverChannels->data_array[0]->extendedData->data = Icb_ChannelCorrectionData_Create(m_session_send);
