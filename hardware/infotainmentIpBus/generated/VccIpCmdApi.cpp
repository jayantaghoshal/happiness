...
std::string toString(ServiceId sid, OperationId oid, const char *separator)
{
    ...
    static const std::vector<OperationIdStringMapping> operationIdStringMapping = {
        ...
        {CombinedId(ServiceId::CommonPSIMPhoneConnectivity, OperationId::PSIMNetworkOperators), "PSIMNetworkOperators"},
        ...
        {CombinedId(ServiceId::DiagnosticManagement, OperationId::TextFromOperatorToUser), "TextFromOperatorToUser"},
        ...
        {CombinedId(ServiceId::DiagnosticManagement, OperationId::TextFromUserToOperator), "TextFromUserToOperator"},
        {CombinedId(ServiceId::DiagnosticManagement, OperationId::RequestRemoteDiagnostics),
         "RequestRemoteDiagnostics"},
        {CombinedId(ServiceId::DiagnosticManagement, OperationId::AbortRemoteDiagnostics), "AbortRemoteDiagnostics"},
        ...
        {CombinedId(ServiceId::InfotainmentPlatform, OperationId::DimFullAppScreenUpdate), "DimFullAppScreenUpdate"},
