...
docker_run "zip -r out/flash-files.zip ./out/target/product/ihu_vcc/fast_flashfiles ./out/host/linux-x86/bin/fastboot ./out/host/linux-x86/bin/adb ./out/host/linux-x86/bin/aapt"
