...
bootstrap_docker_run "repo sync --no-clone-bundle --current-branch -q -j4 aosp/platform/build/soong aosp/platform/build/blueprint aosp/platform/prebuilts/go/linux-x86 aosp/platform/prebuilts/build-tools" || die "repo sync failed"
