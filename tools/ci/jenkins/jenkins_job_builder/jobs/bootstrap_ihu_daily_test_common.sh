...
bootstrap_docker_run "repo sync --no-clone-bundle --current-branch -q -j32 vendor/delphi/android_vendor vendor/delphi/bb_reprogramming vendor/delphi/binaries_android_tunermngr vendor/delphi/binaries_android_diagnostics" || die "repo sync failed"
