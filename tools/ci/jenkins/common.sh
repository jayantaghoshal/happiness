...
#       Python.
TEST_BLACKLIST="vendor/volvocars/hardware/climate/.*\|vendor/volvocars/hardware/signals/vehiclesignalsdaemon/.*\|vendor/volvocars/hardware/powermoding/.*\|vendor/volvocars/hardware/localconfig.*\|vendor/volvocars/hardware/netman.*"
